module gen_diag
! Time-stamp: "2008-11-02 04:09:59 Clifford Noble"
! This generalized eigensolution routine replaces the standard
! scalapack routine: the divide and conquer standard eigensolution
! routine is use.
