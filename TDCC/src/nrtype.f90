MODULE nrtype
  ...
  !Symbolic names or kind types of single-and double-precision complex:
  ...
  !Derived data types or sparse matrices,single and double precision (see use in Chapter B2):
  TYPE sprs2_sp
     INTEGER(I4B)::n,len
