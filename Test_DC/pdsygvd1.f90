!======================================================================
  subroutine PDSYGVD1 (n, ia, ja, desch, hmat, ib, jb, descb, b, &
...
!----------------------------------------------------------------------
    ...
    real(wp), intent(inout) :: hmat(np*nq), b(np*nq), z(np*nq)
    real(wp), intent(out)   :: evals(n)              ! eigenvalues
