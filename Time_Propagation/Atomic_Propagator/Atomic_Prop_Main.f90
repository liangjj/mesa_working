!deck Atomic_Prop_Main
!**begin prologue     Atomic_Prop_Main
...
!                       ----                    --------
!                     Input_Prop             Atomic_Prop_Sources
!                     Space_Prop             Atomic_Prop_Sources
!                     Regional_Matrices      Atomic_Prop_Modules:regional_module
!                     v_couple               Atomic_Prop_Sources
!                     Propagation_Driver     Atomic_Prop_Modules:Propagation_Module

!
!**modules used         Name                    Location               
!                       ----                    --------
!                    dvrprop_global          Modules   
!                    Propagation_Module      Atomic_Prop_Modules
!
!**end prologue       Atomic_Prop_Main
  PROGRAM Atomic_Prop_Main
...
!
  ...
  time(1)=secnds(0.0)
  CALL Atomic_Prop_Input(ham_type,preconditioner,file_directory)
