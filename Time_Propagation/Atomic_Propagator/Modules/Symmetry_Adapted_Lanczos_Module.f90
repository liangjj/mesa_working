...
!***                  algorithm with explicit use of atomic symmetry.  
...
!***********************************************************************
!
                           INTERFACE atomic_lanczos
             MODULE PROCEDURE atomic_lanczos_d,                                   &
                              atomic_lanczos_z
                       END INTERFACE atomic_lanczos
!
                           INTERFACE atomic_lanczos_vec
             MODULE PROCEDURE atomic_lanczos_vec_d,                               &
                              atomic_lanczos_vec_z
                       END INTERFACE atomic_lanczos_vec
!
                           INTERFACE atomic_lanczos_hamiltonian
             MODULE PROCEDURE atomic_lanczos_hamiltonian              
                       END INTERFACE atomic_lanczos_hamiltonian
!
                           INTERFACE atomic_lanczos_convergence_test
             MODULE PROCEDURE atomic_lanczos_convergence_test_d,                  &
                              atomic_lanczos_convergence_test_z  
                       END INTERFACE atomic_lanczos_convergence_test
!
!***********************************************************************
!***********************************************************************
                              CONTAINS
!***********************************************************************
!***********************************************************************
!**begin prologue     atomic_lanczos_d
...
!**end prologue       atomic_lanczos_d
!***********************************************************************
  SUBROUTINE atomic_lanczos_d(v_in,v_out)
  IMPLICIT NONE
     ...
     IF (packed_matrices) THEN 
         call column_packed_matrix_on_vector                              &
                            (lanczos_basis(1:n3d,it),                     &
                             ...
                             mat_var(3)%row_index,mat_var(3)%number,n3d)
     ELSE
