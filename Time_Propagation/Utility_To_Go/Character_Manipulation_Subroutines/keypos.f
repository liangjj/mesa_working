*deck @(#)keypos.f	5.1  11/6/94
      subroutine keypos(string,key,ref,start,end)
c
c***begin prologue     keypos
c***date written       870901  (yymmdd)
c***revision date      yymmdd  (yymmdd)
c
c***keywords           keyword search
c***author             saxe, paul (lanl)
c***source             @(#)keypos.f	5.1   11/6/94
c***purpose            to return the location of the string
c     associated with a keyword.
c***description
c                call keypos(string,key,ref,start,end)
c
c      this function searches for a keyword in a character string and
c      returns the location of
c      an associated substring delimited by , blanks or enclosed
