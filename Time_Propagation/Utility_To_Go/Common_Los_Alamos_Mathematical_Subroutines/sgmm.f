...
c                                                                       
      do  15    j=1,l                                                   
   15     call sgmv (m,n,a,ia,b(1,j),1,c(1,j),1,jb)                    
      return                                                            
   50 continue                                                          
c                                                                       
...
c                                                                       
      do 55    j=1,l                                                    
   55     call sgmv (m,n,a,ia,b(1,j),1,c(1,j),1,jb)                    
      return                                                            
   30 continue                                                          
c                                                                       
...
c                                                                       
      do 35    j=1,l                                                    
   35     call sgmv (m,n,a,ia,b(j,1),ib,c(1,j),1,jb)                   
      return                                                            
   20 continue                                                          
c                                                                       
...
c                                                                       
      do 25    j=1,l                                                    
   25     call sgmv (m,n,a,ia,b(1,j),1,c(j,1),ic,jb)                   
      return                                                            
   70 continue                                                          
c                                                                       
...
c                                                                       
      do 75    j=1,l                                                    
   75     call sgmv (m,n,a,ia,b(j,1),ib,c(1,j),1,jb)                   
      return                                                            
   60 continue                                                          
c                                                                       
...
c                                                                       
      do 65    j=1,l                                                    
   65     call sgmv (m,n,a,ia,b(1,j),1,c(j,1),ic,jb)                   
      return                                                            
   40 continue                                                          
c                                                                       
c** this routine forms the matrix product ab(transpose) and stores      
c   the its transpose in c                                              
cinput                                                                  
c  m = the number of rows of a and columns of c.                        
...
c                                                                       
      do 45    j=1,l                                                    
   45     call sgmv (m,n,a,ia,b(j,1),ib,c(j,1),ic,jb)                  
      return                                                            
   80 continue                                                          
c                                                                       
...
c  c contains the transpose of the product a(transpose)b(transpose)     
      do 85    j=1,l                                                    
   85     call sgmv (m,n,a,ia,b(j,1),ib,c(j,1),ic,jb)                  
      return                                                            
      end                                                               
