...
!
  ...
  DO i=1,num_reg(q),2
     call umat_reg(mat_reg_d(i,q)%eigval_mat_d,            &
                   ...
                   mat_reg_d(i,q)%eigvec_mat_d,            &
                   mat_reg_d(i,q)%cosine_t_mat_4(1,1,1),   &
                   mat_reg_d(i,q)%sine_t_mat_4(1,1,1),     &
                   si_d,ci_d,tau(1),nfun_reg(i,q),i)
     call umat_reg(mat_reg_d(i,q)%eigval_mat_d,            &
                   mat_reg_d(i,q)%eigvec_mat_d,            &
                   mat_reg_d(i,q)%eigvec_mat_d,            &
                   mat_reg_d(i,q)%cosine_t_mat_4(1,1,2),   &
                   mat_reg_d(i,q)%sine_t_mat_4(1,1,2),     &
                   si_d,ci_d,tau(2),nfun_reg(i,q),i)
     call umat_reg(mat_reg_d(i,q)%eigval_mat_d,            &
                   mat_reg_d(i,q)%eigvec_mat_d,            &
                   mat_reg_d(i,q)%eigvec_mat_d,            &
                   mat_reg_d(i,q)%cosine_t_mat_4(1,1,3),   &
                   mat_reg_d(i,q)%sine_t_mat_4(1,1,3),     &
