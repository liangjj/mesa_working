...
!**end prologue       h_v_1d_d
  SUBROUTINE h_v_1d_d(v_in,v_out,nv)
...
!\center  Remember that the last few columns must be treated specially.
  ELSE
     IF(row(1) == 2) THEN
        CALL ds3_bmm(v_in,v_out,1,1,nv,nphy(1),1)
     ELSE IF(row(1) == 3) THEN
        CALL ds5_bmm(v_in,v_out,1,1,nv,nphy(1),1)
     ELSE IF(row(1) == 4) THEN
        CALL ds7_bmm(v_in,v_out,1,1,nv,nphy(1),1)
     ELSE
...
!
  call d_mul(v_out,v_tot,v_in,nv)
  IF(log_prp(3)) THEN
...
!**end prologue       h_v_2d_d
  SUBROUTINE h_v_2d_d(v_in,v_out,nv)
  USE dvrprop_global_it
  USE dvr_global
  USE dvr_shared
  IMPLICIT NONE
...
!
  ...
  ELSE
     IF(row(2) == 2) THEN
        CALL ds3_bmm(v_in,v_out,1,nv,nphy(1),nphy(2),2)
        IF(row(1) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
        ELSE IF(row(1) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
        ELSE IF(row(1) == 4) THEN
           CALL ds7_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
        ELSE
           CALL lnkerr('error')
        END IF
     ELSE IF(row(2) == 3) THEN
        CALL ds5_bmm(v_in,v_out,1,nv,nphy(1),nphy(2),2)
        IF(row(1) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
        ELSE IF(row(1) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
     ...
     ELSE IF(row(2) == 4) THEN
        CALL ds7_bmm(v_in,v_out,1,nv,nphy(1),nphy(2),2)
        IF(row(1) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
        ELSE IF(row(1) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2),1)
...
!***end prologue       h_v_3d_d
  SUBROUTINE h_v_3d_d(v_in,v_out,nv)
  USE dvrprop_global_it
  USE dvr_global
  USE dvr_shared
  IMPLICIT NONE
...
!
  ...
  ELSE
     IF(row(3) == 2) THEN
        CALL ds3_bmm(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),3)
        IF(row(2) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
        ELSE IF(row(2) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
        ELSE IF(row(2) == 4) THEN
           CALL ds7_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
        ELSE
           CALL lnkerr('quit')
        END IF
        IF(row(1) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,1,nv,nphy(1),nphy(2)*nphy(3),1)
        ELSE IF(row(1) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,1,nv,nphy(1),nphy(3)*nphy(2),1)
        ELSE IF(row(1) == 4) THEN
           CALL ds7_bmmt(v_in,v_out,1,nv,nphy(1),nphy(3)*nphy(2),1)
        ELSE
           CALL lnkerr('quit')
        END IF
     ELSE IF(row(3) == 3) THEN
        CALL ds5_bmm(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),3)
        IF(row(2) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
        ELSE IF(row(2) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
     ...
     ELSE IF(row(3) == 4) THEN
        CALL ds7_bmm(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),3)
        IF(row(2) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
        ELSE IF(row(2) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,nv,nphy(1),nphy(2),nphy(3),2)
        ...
        END IF
        IF(row(1) == 2) THEN
           CALL ds3_bmmt(v_in,v_out,1,nv,nphy(1),nphy(3)*nphy(2),1)
        ELSE IF(row(1) == 3) THEN
           CALL ds5_bmmt(v_in,v_out,1,nv,nphy(1),nphy(3)*nphy(2),1)
        ELSE IF(row(1) == 4) THEN
           CALL ds7_bmmt(v_in,v_out,1,nv,nphy(1),nphy(3)*nphy(2),1)
...
!***end prologue       dvr_mat_mul_1d_d
  SUBROUTINE dvr_mat_mul_1d_d(v_in,v_out,nv)
  USE dvrprop_global_it
  USE dvr_shared
  USE dvr_global
  IMPLICIT NONE
...
!***end prologue       dvr_mat_mul_2d_d
  SUBROUTINE dvr_mat_mul_2d_d(v_in,v_out,nv)
  USE dvrprop_global_it
  USE dvr_shared
  USE dvr_global
  IMPLICIT NONE
...
!***end prologue       dvr_mat_mul_3d_d
  SUBROUTINE dvr_mat_mul_3d_d(v_in,v_out,nv)
  USE dvrprop_global_it
  USE dvr_shared
  USE dvr_global
  IMPLICIT NONE
...
SUBROUTINE d_mul(v_out,m_d,v_in,nv)
  USE dvrprop_global_it
  USE dvr_global
  USE dvr_shared
  IMPLICIT NONE
  INTEGER                             :: nv
  INTEGER                             :: i
  REAL*8, DIMENSION(n3d,nv)           :: v_in, v_out
