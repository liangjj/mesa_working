...
!**references
!**routines called
!**end prologue       c_vect_08
  SUBROUTINE c_vect_08(etemp,itemp,root)
  USE dvrprop_global
  USE dvr_shared
  USE dvr_global
  IMPLICIT NONE
...
!
     ...
     DO  i=1,nphy(1)
         DO j=1,nphy(2)
            count = count + 1
             psi_08(count,1) =  grid(1)%eigvec_0(i,itemp(root,1)) &
