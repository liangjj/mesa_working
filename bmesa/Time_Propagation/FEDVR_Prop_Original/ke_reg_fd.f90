...
!***end prologue       ke__reg_fd
  SUBROUTINE ke_reg_fd(k_global,k_region,n_region,reg)
  USE arnoldi_global
  ...
  REAL*8, DIMENSION(n_region)            :: k_global
