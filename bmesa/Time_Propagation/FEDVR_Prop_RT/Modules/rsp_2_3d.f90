...
!***end prologue       rsp_2_3d
  SUBROUTINE rsp_2_3d(wave_function,scratch_vector)
     ...
     USE exp_off_diagonal
  IMPLICIT NONE
  REAL*8, DIMENSION(nphy(3),nphy(2),nphy(1),2)      :: wave_function, scratch_vector
!
