...
!**references
!**routines called
!**end prologue       v_m_v_rt
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                         INTERFACE v_m_v_rt_gen
              MODULE PROCEDURE v_m_v_rt_gen_d
                     END INTERFACE v_m_v_rt_gen
                         INTERFACE v_m_v_rt_2
              MODULE PROCEDURE     v_m_v_rt_2_d
                     END INTERFACE v_m_v_rt_2
                         INTERFACE v_m_v_rt_3
              MODULE PROCEDURE     v_m_v_rt_3_d
                     END INTERFACE v_m_v_rt_3
                         INTERFACE v_m_v_rt_4
              MODULE PROCEDURE     v_m_v_rt_4_d
                     END INTERFACE v_m_v_rt_4
                         INTERFACE v_m_v_rt_5
              MODULE PROCEDURE     v_m_v_rt_5_d
                     END INTERFACE v_m_v_rt_5
                         INTERFACE v_m_v_rt_6
              MODULE PROCEDURE     v_m_v_rt_6_d
                     END INTERFACE v_m_v_rt_6
                         INTERFACE v_m_v_rt_7
              MODULE PROCEDURE     v_m_v_rt_7_d
                     END INTERFACE v_m_v_rt_7
                         INTERFACE v_m_v_rt_8
              MODULE PROCEDURE     v_m_v_rt_8_d
                     END INTERFACE v_m_v_rt_8
                         INTERFACE v_m_v_rt_9
              MODULE PROCEDURE     v_m_v_rt_9_d
                     END INTERFACE v_m_v_rt_9
                         INTERFACE v_m_v_rt_10
              MODULE PROCEDURE     v_m_v_rt_10_d
                     END INTERFACE v_m_v_rt_10
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                              CONTAINS
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!***end prologue       
!
  SUBROUTINE v_m_v_rt_gen_d(real_v,imag_v,              &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   
END SUBROUTINE v_m_v_rt_gen_d
!
!
!deck v_m_v_rt_2_d
!***begin prologue     v_m_v_rt_2_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_2_d
!
  SUBROUTINE v_m_v_rt_2_d(real_v,imag_v,real_v_scr,imag_v_scr,    &
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_2_d
!
!
!deck v_m_v_rt_3_d
!***begin prologue     v_m_v_rt_3_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_3_d
!
  SUBROUTINE v_m_v_rt_3_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_3_d
!
!
!deck v_m_v_rt_4_d
!***begin prologue     v_m_v_rt_4_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_4_d
!
  SUBROUTINE v_m_v_rt_4_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_4_d
!
!
!deck v_m_v_rt_5_d
!***begin prologue     v_m_v_rt_5_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_5_d
!
  SUBROUTINE v_m_v_rt_5_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_5_d
!
!
!deck v_m_v_rt_6_d
!***begin prologue     v_m_v_rt_6_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_6_d
!
  SUBROUTINE v_m_v_rt_6_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_6_d
!
!
!deck v_m_v_rt_7_d
!***begin prologue     v_m_v_rt_7_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_7_d
!
  SUBROUTINE v_m_v_rt_7_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_7_d
!
!
!deck v_m_v_rt_8_d
!***begin prologue     v_m_v_rt_8_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_8_d
!
  SUBROUTINE v_m_v_rt_8_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_8_d
!
!
!deck v_m_v_rt_9_d
!***begin prologue     v_m_v_rt_9_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_9_d
!
  SUBROUTINE v_m_v_rt_9_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_9_d
!
!deck v_m_v_rt_10_d
!***begin prologue     v_m_v_rt_10_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_m_v_rt_10_d
!
  SUBROUTINE v_m_v_rt_10_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                           cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!           
  DO i=1,nj
     ...
     real_v_scr(9,i) = cosine_t_mat(9,1) * real_v(1,i)   &
                       ...
                       sine_t_mat(9,9)   * imag_v(9,i)   &
                                         -               &
                       sine_t_mat(9,10)  * imag_v(10,i)   
     real_v_scr(10,i) = cosine_t_mat(10,1) * real_v(1,i)  &
                                         +                &
                       cosine_t_mat(10,2) * real_v(2,i)   &
                                         +                &
                       cosine_t_mat(10,3) * real_v(3,i)   &
                                         +                &   
                       cosine_t_mat(10,4) * real_v(4,i)   &
                                         +                &
                       cosine_t_mat(10,5) * real_v(5,i)   &   
                                         +                &
                       cosine_t_mat(10,6) * real_v(6,i)   &   
                                         +                &
                       cosine_t_mat(10,7) * real_v(7,i)   &   
                                         +                &
                       cosine_t_mat(10,8) * real_v(8,i)   &   
                                         +                &
                       cosine_t_mat(10,9) * real_v(9,i)   &   
                                         +                &
                       cosine_t_mat(10,10) * real_v(10,i) &   
                                         -                &
                       sine_t_mat(10,1)   * imag_v(1,i)   &
                                         -                &
                       sine_t_mat(10,2)   * imag_v(2,i)   &
                                         -                &
                       sine_t_mat(10,3)   * imag_v(3,i)   &
                                         -                &
                       sine_t_mat(10,4)   * imag_v(4,i)   &
                                         -                &
                       sine_t_mat(10,5)   * imag_v(5,i)   &
                                         -                &
                       sine_t_mat(10,6)   * imag_v(6,i)   &
                                         -                &
                       sine_t_mat(10,7)   * imag_v(7,i)   &
                                         -                &
                       sine_t_mat(10,8)   * imag_v(8,i)   &
                                         -                &
                       sine_t_mat(10,9)   * imag_v(9,i)   &
                                         -                &
                       sine_t_mat(10,10)  * imag_v(10,i)   
     ...
     imag_v_scr(9,i) = cosine_t_mat(9,1) * imag_v(1,i)   &
                       ...
                       sine_t_mat(9,9)   * real_v(9,i)   &
                                         +               &
                       sine_t_mat(9,10)  * real_v(10,i)      
     imag_v_scr(10,i) = cosine_t_mat(10,1) * imag_v(1,i)  &
                                         +                &
                       cosine_t_mat(10,2) * imag_v(2,i)   &
                                         +                &
                       cosine_t_mat(10,3) * imag_v(3,i)   &
                                         +                &
                       cosine_t_mat(10,4) * imag_v(4,i)   &
                                         +                &
                       cosine_t_mat(10,5) * imag_v(5,i)   &
                                         +                &
                       cosine_t_mat(10,6) * imag_v(6,i)   &
                                         +                &
                       cosine_t_mat(10,7) * imag_v(7,i)   &
                                         +                &
                       cosine_t_mat(10,8) * imag_v(8,i)   &
                                         +                &
                       cosine_t_mat(10,9) * imag_v(9,i)   &
                                         +                &
                       cosine_t_mat(10,10) * imag_v(10,i) &
                                         +                &
                       sine_t_mat(10,1)   * real_v(1,i)   &
                                         +                &
                       sine_t_mat(10,2)   * real_v(2,i)   &
                                         +                & 
                       sine_t_mat(10,3)   * real_v(3,i)   &
                                         +                &
                       sine_t_mat(10,4)   * real_v(4,i)   &
                                         +                &
                       sine_t_mat(10,5)   * real_v(5,i)   &
                                         +                &
                       sine_t_mat(10,6)   * real_v(6,i)   &
                                         +                &
                       sine_t_mat(10,7)   * real_v(7,i)   &
                                         +                &
                       sine_t_mat(10,8)   * real_v(8,i)   &
                                         +                &
                       sine_t_mat(10,9)   * real_v(9,i)   &
                                         +                &
                       sine_t_mat(10,10)  * real_v(10,i)      

  END DO
  real_v(1:10,:) = real_v_scr(1:10,:)
  imag_v(1:10,:) = imag_v_scr(1:10,:)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_m_v_rt_10_d
END MODULE v_m_v_rt
