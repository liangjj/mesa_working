...
!**references
!**routines called
!**end prologue       v_v_m_rt
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                         INTERFACE v_v_m_rt_gen
              MODULE PROCEDURE v_v_m_rt_gen_d
                     END INTERFACE v_v_m_rt_gen
                         INTERFACE v_v_m_rt_2
              MODULE PROCEDURE     v_v_m_rt_2_d
                     END INTERFACE v_v_m_rt_2
                         INTERFACE v_v_m_rt_3
              MODULE PROCEDURE     v_v_m_rt_3_d
                     END INTERFACE v_v_m_rt_3
                         INTERFACE v_v_m_rt_4
              MODULE PROCEDURE     v_v_m_rt_4_d
                     END INTERFACE v_v_m_rt_4
                         INTERFACE v_v_m_rt_5
              MODULE PROCEDURE     v_v_m_rt_5_d
                     END INTERFACE v_v_m_rt_5
                         INTERFACE v_v_m_rt_6
              MODULE PROCEDURE     v_v_m_rt_6_d
                     END INTERFACE v_v_m_rt_6
                         INTERFACE v_v_m_rt_7
              MODULE PROCEDURE     v_v_m_rt_7_d
                     END INTERFACE v_v_m_rt_7
                         INTERFACE v_v_m_rt_8
              MODULE PROCEDURE     v_v_m_rt_8_d
                     END INTERFACE v_v_m_rt_8
                         INTERFACE v_v_m_rt_9
              MODULE PROCEDURE     v_v_m_rt_9_d
                     END INTERFACE v_v_m_rt_9
                         INTERFACE v_v_m_rt_10
              MODULE PROCEDURE     v_v_m_rt_10_d
                     END INTERFACE v_v_m_rt_10
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                              CONTAINS
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!***end prologue   
!
  SUBROUTINE v_v_m_rt_gen_d(real_v,imag_v,           &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   
END SUBROUTINE v_v_m_rt_gen_d
!
!
!deck v_v_m_rt_2_d
!***begin prologue     v_v_m_rt_2_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_2_d
!
  SUBROUTINE v_v_m_rt_2_d(real_v,imag_v,real_v_scr,imag_v_scr, &
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_2_d
!
!
!deck v_v_m_rt_3_d
!***begin prologue     v_v_m_rt_3_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_3_d
!
  SUBROUTINE v_v_m_rt_3_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_3_d
!
!
!deck v_v_m_rt_4_d
!***begin prologue     v_v_m_rt_4_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_4_d
!
  SUBROUTINE v_v_m_rt_4_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_4_d
!
!
!deck v_v_m_rt_5_d
!***begin prologue     v_v_m_rt_5_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_5_d
!
  SUBROUTINE v_v_m_rt_5_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_5_d
!
!
!deck v_v_m_rt_6_d
!***begin prologue     v_v_m_rt_6_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_6_d
!
  SUBROUTINE v_v_m_rt_6_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_6_d
!
!
!deck v_v_m_rt_7_d
!***begin prologue     v_v_m_rt_7_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_7_d
!
  SUBROUTINE v_v_m_rt_7_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_7_d
!
!
!deck v_v_m_rt_8_d
!***begin prologue     v_v_m_rt_8_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_8_d
!
  SUBROUTINE v_v_m_rt_8_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_8_d
!
!
!deck v_v_m_rt_9_d
!***begin prologue     v_v_m_rt_9_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_9_d
!
  SUBROUTINE v_v_m_rt_9_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                          cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END SUBROUTINE v_v_m_rt_9_d
!
!
!deck v_v_m_rt_10_d
!***begin prologue     v_v_m_rt_10_d     
!***date written       031122   (yymmdd)
!***revision date      yymmdd   (yymmdd)
!***keywords           time, dvr, real-space, split-operator, propagation
!***author             schneider, b, i. (nsf)
...
!***references
!***routines called
!***end prologue       v_v_m_rt_10_d
!
  SUBROUTINE v_v_m_rt_10_d(real_v,imag_v,real_v_scr,imag_v_scr, &
                           cosine_t_mat,sine_t_mat,ni,nj)
  IMPLICIT NONE
  INTEGER                                  :: ni, nj
  REAL*8, DIMENSION(ni,nj)                 :: real_v, imag_v
