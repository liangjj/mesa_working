...
!
  IF(spdim == 1) THEN
     CALL dvr_mat_mul_d(v_in,v_out,nphy(1),nv,1)
...
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        CALL dvr_mat_mul_d(v_in,v_out,nphy(2),nphy(1)*nv,2)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
...
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
        CALL dvr_mat_mul_2_d(v_in,v_out,nphy(2),nphy(1),nv,1)
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
        CALL dvr_mat_mul_d(v_in,v_out,nphy(3),nphy(2)*nphy(1)*nv,3)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
...
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        CALL dvr_mat_mul_2_d(v_in,v_out,nphy(3),nphy(2),nphy(1)*nv,2)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
...
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        CALL dvr_mat_mul_2_d(v_in,v_out,nphy(3)*nphy(2),nphy(1),nv,1)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  END IF
...
!
  IF(spdim == 1) THEN
     CALL dvr_mat_mul_z(v_in,v_out,nphy(1),nv,1)
  ELSE IF(spdim == 2) THEN
!
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        CALL dvr_mat_mul_z(v_in,v_out,nphy(2),nphy(1)*nv,2)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!       This code is for the general problem involving nphy(1),
!       V(2,1) * H(1,1)
...
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
        CALL dvr_mat_mul_2_z(v_in,v_out,nphy(2),nphy(1),nv,1)
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ELSE IF(spdim == 3) THEN
!
...
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
        CALL dvr_mat_mul_z(v_in,v_out,nphy(3),nphy(2)*nphy(1)*nv,3)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!        This is for the general case involving the matrix multiply 
!        involving nphy(2), that is, V(3,2,1) * H(2,2)
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        CALL dvr_mat_mul_2_z(v_in,v_out,nphy(3),nphy(2),nphy(1)*nv,2)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
!        This is for the general problem involving the matrix multiply 
!        for nphy(1), that is, V(3,2,1) * H(1,1)
!
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        CALL dvr_mat_mul_2_z(v_in,v_out,nphy(3)*nphy(2),nphy(1),nv,1)
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  END IF
