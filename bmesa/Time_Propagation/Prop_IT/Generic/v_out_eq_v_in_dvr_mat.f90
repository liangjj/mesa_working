...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                         MODULE v_out_eq_v_in_dvr_mat
!**begin prologue     v_out_eq_v_in_dvr_mat
...
!**references
!**routines called
!**end prologue       v_out_eq_v_in_dvr_mat
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                         INTERFACE v_v_so_mat_gen
              MODULE PROCEDURE v_v_so_mat_gen_d, v_v_so_mat_gen_z
                     END INTERFACE v_v_so_mat_gen
                         INTERFACE v_v_so_mat_2             
              MODULE PROCEDURE     v_v_so_mat_2_d, v_v_so_mat_2_z
                     END INTERFACE v_v_so_mat_2
                         INTERFACE v_v_so_mat_3             
              MODULE PROCEDURE     v_v_so_mat_3_d, v_v_so_mat_3_z        
                     END INTERFACE v_v_so_mat_3
                         INTERFACE v_v_so_mat_4
              MODULE PROCEDURE     v_v_so_mat_4_d, v_v_so_mat_4_z
                     END INTERFACE v_v_so_mat_4
                         INTERFACE v_v_so_mat_5
              MODULE PROCEDURE     v_v_so_mat_5_d, v_v_so_mat_5_z
                     END INTERFACE v_v_so_mat_5
                         INTERFACE v_v_so_mat_6
              MODULE PROCEDURE     v_v_so_mat_6_d, v_v_so_mat_6_z
                     END INTERFACE v_v_so_mat_6
                         INTERFACE v_v_so_mat_7
              MODULE PROCEDURE     v_v_so_mat_7_d, v_v_so_mat_7_z        
                     END INTERFACE v_v_so_mat_7
                         INTERFACE v_v_so_mat_8
              MODULE PROCEDURE     v_v_so_mat_8_d, v_v_so_mat_8_z
                     END INTERFACE v_v_so_mat_8
                         INTERFACE v_v_so_mat_9
              MODULE PROCEDURE     v_v_so_mat_9_d, v_v_so_mat_9_z
                     END INTERFACE v_v_so_mat_9
                         INTERFACE v_v_so_mat_10
              MODULE PROCEDURE     v_v_so_mat_10_d, v_v_so_mat_10_z
                     END INTERFACE v_v_so_mat_10             
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                         INTERFACE v_v_mat_gen
              MODULE PROCEDURE v_v_mat_gen_d, v_v_mat_gen_z
                     END INTERFACE v_v_mat_gen
                         INTERFACE v_v_mat_2             
              MODULE PROCEDURE     v_v_mat_2_d, v_v_mat_2_z
                     END INTERFACE v_v_mat_2
                         INTERFACE v_v_mat_3             
              MODULE PROCEDURE     v_v_mat_3_d, v_v_mat_3_z             
                     END INTERFACE v_v_mat_3
                         INTERFACE v_v_mat_4
              MODULE PROCEDURE     v_v_mat_4_d, v_v_mat_4_z
                     END INTERFACE v_v_mat_4
                         INTERFACE v_v_mat_5
              MODULE PROCEDURE     v_v_mat_5_d, v_v_mat_5_z
                     END INTERFACE v_v_mat_5
                         INTERFACE v_v_mat_6
              MODULE PROCEDURE     v_v_mat_6_d, v_v_mat_6_z
                     END INTERFACE v_v_mat_6
                         INTERFACE v_v_mat_7
              MODULE PROCEDURE     v_v_mat_7_d, v_v_mat_7_z            
                     END INTERFACE v_v_mat_7
                         INTERFACE v_v_mat_8
              MODULE PROCEDURE     v_v_mat_8_d, v_v_mat_8_z
                     END INTERFACE v_v_mat_8
                         INTERFACE v_v_mat_9
              MODULE PROCEDURE     v_v_mat_9_d, v_v_mat_9_z
                     END INTERFACE v_v_mat_9
                         INTERFACE v_v_mat_10
              MODULE PROCEDURE     v_v_mat_10_d, v_v_mat_10_z
...
!
  DO k=1,nk
     DO j=1,nk
        v_scr(:,j) = v_scr(:,j) + dvr_mat(k,j) * v(:,k) 
     END DO
  END DO
!
  v(:,1:nk) = v_scr(:,1:nk)
...
!
!***description        Computes the vector propagator matrix multipiles
!***                   for the gen_zeral FEDVR HAmiltonian. 
!***                   The routine is not needed in 1D problems. 
!***                   In 2D, the i index runs over the number
!                      of points in the y coordinate while in 3D, it runs over
!                      the product of the number of points in the z and y coordinates.
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                END      MODULE v_out_eq_v_in_dvr_mat
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
