...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
             ...
             MODULE PROCEDURE eigen_solve_1d, eigen_solve_2d,   &
                              eigen_solve_3d
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!deck eigen_solve_1d.f
!***begin prologue     eigen_solve_1d
...
!***                   be performed before entry into eigen_solve 
!***references
!***routines called    iosys, util and mdutil
!***end prologue       eigen_solve_1d
  SUBROUTINE eigen_solve_1d(vector_0,vector,lambda)
...
END SUBROUTINE eigen_solve_1d
!deck eigen_solve_2d.f
!***begin prologue     eigen_solve_2d
!***date written       040706   (yymmdd)
!***revision date               (yymmdd)
!***keywords           eigenvalues
!***author             schneider, b. i.(nsf)
...
!***references
!***routines called    iosys, util and mdutil
!***end prologue       eigen_solve_2d
  SUBROUTINE eigen_solve_2d(vector_0,vector,g_2,lambda)
  USE arnoldi_global
  USE dvr_shared  
  IMPLICIT NONE
  INTEGER                                  :: i 
...
!
  ...
  write(iout,1) lambda
1 FORMAT(/,5x,'Energy from Exponential            = ',e20.12)
END SUBROUTINE eigen_solve_2d
!deck eigen_solve_3d.f
!***begin prologue     eigen_solve_3d
!***date written       040706   (yymmdd)
!***revision date               (yymmdd)
...
!***references
!***routines called    iosys, util and mdutil
!***end prologue       eigen_solve_3d
  SUBROUTINE eigen_solve_3d(vector_0,vector,g_2,g_3,lambda)
  USE arnoldi_global
  USE dvr_shared  
  IMPLICIT NONE
  INTEGER                                      :: i, j 
