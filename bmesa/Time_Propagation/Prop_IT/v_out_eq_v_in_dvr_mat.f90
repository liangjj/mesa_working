...
!***end prologue       
!
  SUBROUTINE v_v_so_mat_gen_z(v_r,          &
                              v_i,          &
                              v_scr_r,      &
                              v_scr_i,      &
                              cos_mat,      &
...
!
  DO k=1,nk
     DO j=1,nk
        v_scr_r(:,j) = v_scr_r(:,j) + v_r(:,k) * cos_mat(k,j)      &
                                    - v_i(:,k) * sin_mat(k,j)
        v_scr_i(:,j) = v_scr_i(:,j) + v_i(:,k) * cos_mat(k,j)      &
                                    + v_r(:,k) * sin_mat(k,j)
     END DO
  END DO
!
...
!
  SUBROUTINE v_v_so_mat_10_z(v_r,               &
                             v_i,               &
                             v_scr_r,           &
                             v_scr_i,           &
                             cos_mat,           &
...
!           
  ...
  v_scr_r(:,10) = v_scr_r(:,10)                                &
                              ...
                              - v_i(:,8)  * sin_mat(8,10)      &
                              - v_i(:,9)  * sin_mat(9,10)      &
                              - v_i(:,10) * sin_mat(10,10)
  v_scr_i(:,10) = v_scr_i(:,10)                                &
                              + v_i(:,1)  * cos_mat(1,10)      &
                              + v_i(:,2)  * cos_mat(2,10)      &
                              + v_i(:,3)  * cos_mat(3,10)      &
                              + v_i(:,4)  * cos_mat(4,10)      &
