...
!***references
!***routines called
!***end prologue       v_dw_plus
  SUBROUTINE v_dw_plus(v,q,t,n,prn)
  USE io
  USE potential
  IMPLICIT NONE
  INTEGER                                :: n
