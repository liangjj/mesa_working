...
!
    ...
    ELSEIF (typwt == 'hermite') then
        CALL ke_hermite(mat(tr(i)),grid(pr(i)),grid(dpr(i)),      &
                        grid(ddpr(i)),grid(qr(i)),grid(wtr(i)),   &
                        npt(i),i)
    ...
    ELSE IF(typwt == 'laguerre' ) then
        CALL ke_laguerre(mat(tr(i)),grid(pr(i)),grid(dpr(i)),     &
                         grid(ddpr(i)),grid(wtr(i)),npt(i),i)
        CALL p_laguerre (mat(p_momr(i)),grid(pr(i)),grid(pr(i)),  &
                         grid(dpr(i)),grid(wtr(i)),npt(i),i)
    ELSE IF(typwt == 'r' ) then
        CALL ke_cyl(mat(tr(i)),grid(pr(i)),grid(dpr(i)),          &
                    grid(qr(i)),grid(wtr(i)),npt(i),i)
    ELSE
