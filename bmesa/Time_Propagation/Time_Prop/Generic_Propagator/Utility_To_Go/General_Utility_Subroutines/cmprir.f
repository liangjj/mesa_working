*deck cmprir
      subroutine cmprir(a,rowv,colv,n,m,ia,ja,title,rowt,colt,iout)
  ...
  400            continue
         ...
         ibeg=iend
   10 continue
   20 format(a8,10x,3(8x,i4,8x))
   30 format(/,18x,3(8x,i4,8x))
  200 format(a8)
   50 format(a8,7f10.5)
  500 format(a8,10x,6f10.5)
   60 format(8x,7f10.5)
  600 format(18x,6f10.5)
      return
      end
