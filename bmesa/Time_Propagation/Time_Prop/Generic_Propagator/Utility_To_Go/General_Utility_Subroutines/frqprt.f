*deck @(#)frqprt.f	5.1  11/6/94
      subroutine frqprt(a,md,nd,nrows,ncols,lrow,lcol,rowlab,
     $                  collab,isym,eig,ifeig)
c***begin prologue     frqprt.f
c***date written       yymmdd  
c***revision date      11/6/94      
c
c***keywords           
c***author             page, michael (nrl)
c***source             @(#)frqprt.f	5.1   11/6/94
c***purpose            prints frequencies 
c***description
c     
c    
c
...
c
      ...
      parameter (coldat=5)
c
 9000 format(21x,10(4x,i6))
 9010 format(5x,'frequencies -- ',1x,10f10.1)
 9020 format(1x,a80)
 9030 format(1x,i9,11x,5f10.5)
 9040 format(1x,10x,a8,2x,5f10.5)
 9050 format(1x,2x,a16,2x,5f10.5)
 9060 format(1x,4x,i3,2x,a8,3x,5f10.5)
 9070 format(1x,i3,1x,a16,5f10.5)
c
