!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                      MODULE regional_diagonalization
                      USE dvr_global
                      USE dvrprop_global
!**begin prologue     regional_diagonalization
...
!**references
!**routines called
!**end prologue       regional_diagonalization
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                        CONTAINS
...
!***end prologue       regional_diag
!
  SUBROUTINE regional_diag(k_region,eval_region,evec_region,         &
                           n_region,reg)
  IMPLICIT NONE
...
!
  ...
  END SUBROUTINE regional_diag  
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END MODULE regional_diagonalization
