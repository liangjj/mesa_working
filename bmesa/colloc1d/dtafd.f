...
c***routines called 
c***                   
      subroutine dtafd(card,type,rbeg,rend,nreg,npts,nwts,
     1                 ptot,wtot,ptfd,wtfd,ng,nrmax,ngmax)
...
c     quadratures do not contain the beginning or endpoint of the interval
 ...
 50       continue    
      ...
      write(iout,4)
      write(iout,5) ptfd, wtfd
      write(iout,6) (ptot(i),i=1,ng)
      write(iout,7) (wtot(i),i=1,ng)
      return
 1    format(/,1x,'finite difference region coarse grid data')
