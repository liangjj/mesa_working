...
c
 ...
 10       continue
      ...
      call iosys('write integer "number of integration points" to '//
     1           'lamdat',1,n,0,' ')
      call iosys('write real "integration points" to lamdat',
     1            n,x,0,' ')
      call iosys('write real "integration weights" to lamdat',
     1            n,wts,0,' ')                   
      return
      end       
