...
c***                   and solve linerar system on request.
c***                   
c***                   
c***references         
c
...
c***end prologue       lschr
      subroutine lschr(h01,ch01,h02,ch02,h03,ch03,v,ham,cham,rhs,crhs,
     1                 energy,ind,ipvt,n,nrhs,n1,n2,n3,dim,
     2                 withv,op,prnt,mattyp)
      implicit integer (a-z)
      real*8 h01, h02, h03, v, ham, rhs, energy
      complex*16 ch01, ch02, ch03, cham, crhs
      character*80 title
      character*16 fptoc
      ...
      dimension v(n), ham(n,n), rhs(n,nrhs), ipvt(n), ind(n,*)
      dimension cham(n,n), crhs(n,nrhs)
      common/io/inp, iout
c
 ...
 80      continue                            
         ...
         if(op) then
            write(iout,1) title
            call lsolve(ham,cham,rhs,crhs,ipvt,n,nrhs,n,mattyp)
         endif
      else               
         call rzero(ham,n*n)
         if(withv) then            
 ...
 1000     continue            
      ...
      return         
    1 format(/,5x,'solve time-independent ',a3,' dimensional '
     1            'inhomogeneous schroedinger equation')
      end       
