...
c
      ...
      notim=chrkey(ops,'m6294=time-dimension','no',' ')
      nospac=chrkey(ops,'m6294=space-dimension','yes',' ')
      ...
      check=logkey(ops,'m6294=check-orthogonality',.false.,' ')
      prall=logkey(ops,'print=m6294=all',.false.,' ')
      writon=logkey(ops,'read-iosys',.false.,' ')
      prnwpt=logkey(ops,'print=m6294=points',.false.,' ')
      prnply=logkey(ops,'print=m6294=polynomials',.false.,' ')
      if(prall) then
         prnwpt=.true.
         prnply=.true.
      endif
 ...
 30            continue   
     ...
     1                         npt,nmax,typfn,maxgrd,maxd,modfed)
               endif 
