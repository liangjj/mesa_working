*deck @(#)tocmplx.f
      subroutine tocmplx(eigc,vlc,vrc,eigr,eigi,vl,vr,ovlp,n)
...
c
 ...
 20         continue
      ...
      enddo
c      title='eigenvalues in complex form'
c      call prntcm(title,eigc,n,1,n,1,iout)
c      title='left eigenvectors in complex form'
c      call prntcm(title,vlc,n,n,n,n,iout)
c      title='right eigenvectors in complex form'
c      call prntcm(title,vrc,n,n,n,n,iout)
c      call cehbtc(ovlp,vlc,vrc,n,n,n)
c      title='overlap matrix'
c      call prntcm(title,ovlp,n,n,n,n,iout)
c
      return
      end
