...
c***end prologue       hamil
     ...
     1                 n1,n2,n3,dim,n,prnt,ntot,incore,title,withv)
      implicit integer (a-z)
      real*8 h01, h02, h03
      real*8 hbuf, diag, ham, v, dum
      character*(*) title
      character*1 itoc
      logical prnt, incore, withv
 ...
 40         continue
            diag(indi) = diag(indi) + h01(i1,i1) + h02(j1,j1)
 30      continue
