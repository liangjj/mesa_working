...
export LDFLAGS="-lU77 -m64 -X-map -Xmap.out"

export FFLAGS90=

export FFLAGSC="-c -g -s -f -N15 -m64"
...
export BLASUSE=" -L/Users/lucchese/Applications/lapacki4/lapack-3.1.1 -llapack_LINUX -lblas_LINUX"
