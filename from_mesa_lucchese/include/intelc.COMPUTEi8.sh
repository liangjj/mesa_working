...
export MAXBIG=2000      # maximum number of parital waves + scattering functions summed over channels
...
export BLASUSE="-L/home/r-lucchese/Applications/lapack/COMPUTEi8/lapack-3.5.0 -lrefblas"
