*deck %W%  %G%
      subroutine pm111(z,a)
c***begin prologue      m111
c***date written        880114   (yymmdd)
c***revision date       7/7/93   
c***keywords
c                       m111, link 111 transform force constants
...
c
      common/io/inp,iout
c
 1000 format(' in m111 : top,maxcor ',2i20)
c
c     get the link options.
      call iosys('read character options from rwf',-1,0,0,ops)
c
c     --- decide if we want to do this -----------------------------------
...
c
         call getscm(top,z,maxcor,'m111',0)
