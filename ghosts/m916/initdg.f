...
c
cvax  extended dummy int,d,ijadd,kadd,ladd,wtw,wtx,wty,wab,ss
c
      integer xor
...
c
      entry diagonal
c
c       write(itape6,*)'  entry diagonal  m iseg ',m,iseg
c
      aos=os(asm+1)
      ia=ja
