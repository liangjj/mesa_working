...
c
      data rmach(1) /2.3e-308/
      data rmach(2) /1.79e+308/
      data rmach(3) /1.0e-14/
      data rmach(4) /1.0e-14/
c
...
c***first executable statement  r1mach                                  
      if (i .lt. 1  .or.  i .gt. 5)                                     
     1   call lnkerr('r1mach -- i out of bounds')              
c                                                                       
      r1mach = rmach(i)                                                 
      return                                                            
c                                                                       
