...
!***end prologue       lobatto
  ...
  SUBROUTINE lobatto(pt_0,pt_n,pt,wt,f,df,ddf,ke,eigv_0,eigvec_0,h,eigv, &
  ...
  REAL*8, DIMENSION(nphy)                     :: eigv_0
  REAL*8, DIMENSION(nphy)                     :: eigv
  REAL*8, DIMENSION(nphy)                     :: v
  REAL*8, DIMENSION(nphy,nphy)                :: f
  REAL*8, DIMENSION(nphy,nphy)                :: df
  REAL*8, DIMENSION(nphy,nphy)                :: ddf
  REAL*8, DIMENSION(nphy,nphy)                :: ke
  REAL*8, DIMENSION(nphy,nphy)                :: eigvec_0
  REAL*8, DIMENSION(nphy,nphy)                :: h
