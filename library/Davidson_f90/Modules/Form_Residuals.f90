!deck Form_Residuals.f
!***begin prologue     Form_Residuals
...
!***references
!***routines called
!***end prologue       Form_Residuals
  SUBROUTINE Form_Residuals(vec,hvec,resid,trmat,eig,eigwrk,b,bwrk,rep,  &
