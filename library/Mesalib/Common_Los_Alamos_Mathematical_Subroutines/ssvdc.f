...
c***end prologue  ssvdc
      integer ldx, n, p,l du, ldv, job, info
      real*8 x(ldx,*), s(*), e(*), u(ldu,*), v(ldv,*), work(*)
c
c
      integer i, iter, j, jobu, k, kase, kk, l, ll, lls, lm1
      integer lp1, ls, lu, m, maxit, mm, mm1, mp1, nct, nctp1
      integer ncu, nrt,nrtp1
      real*8 sdot, t
      real*8 b, c, cs, el, emm1, f, g, snrm2, scale, shift, sl, sm
