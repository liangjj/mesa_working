...
*     .. External Subroutines ..
      EXTERNAL           CLACGV, CLAR2V, CLARGV, CLARTG, CLARTV, CLAZRO,
     $                   CROT, CSCAL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( WANTQ )
     $   CALL CLAZRO( N, N, ZERO, ONE, Q, LDQ )
*
...
*
                     CALL CLARGV( NR, AB( 1, J1-1 ), KD1*LDAB,
     $                            WORK( J1 ), KD1, D( J1 ), KD1 )
*
*                    apply rotations from the right
*
                     DO 10 L = 1, KD - 1
                        CALL CLARTV( NR, AB( L+1, J1-1 ), KD1*LDAB,
...
*
                  ...
                  DO 20 L = 1, KD - 1
                     ...
                     END IF
                     IF( NRT.GT.0 )
     $                  CALL CLARTV( NRT, AB( KD-L, J1+L ), KD1*LDAB,
...
*                    elements which have been created outside the band
*
                     CALL CLARGV( NR, AB( KD1, J1-KD1 ), KD1*LDAB,
     $                            WORK( J1 ), KD1, D( J1 ), KD1 )
*
...
*
                  ...
                  DO 110 L = 1, KD - 1
                     ...
                     END IF
                     IF( NRT.GT.0 )
     $                  CALL CLARTV( NRT, AB( L+2, J1-1 ), KD1*LDAB,
