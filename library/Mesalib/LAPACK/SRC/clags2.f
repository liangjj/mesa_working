...
*  then the transformed (2,2) entry of B is not zero, except when the
...
*     ..
*     .. Local Scalars ..
      REAL               A, AUA11, AUA12, AUA21, AUA22, AVB12,
...
*
            ...
            AVB21 = ABS( SNL )*ABS( B1 ) + ABS( CSR )*ABS1( B2 )
*
...
*
            ...
            ELSE IF( AUA11 / ( ABS1( UA11 )+ABS1( UA12 ) ).LE.AVB12 /
