...
*     .. External Subroutines ..
      EXTERNAL           SLAR2V, SLARGV, SLARTG, SLARTV, SLAZRO, SROT,
     $                   XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
                     CALL SLARGV( NR, AB( 1, J1-1 ), KD1*LDAB,
     $                            WORK( J1 ), KD1, D( J1 ), KD1 )
*
*                    apply rotations from the right
*
                     DO 10 L = 1, KD - 1
                        CALL SLARTV( NR, AB( L+1, J1-1 ), KD1*LDAB,
...
*
                  DO 20 L = 1, KD - 1
                     ...
                     END IF
                     IF( NRT.GT.0 )
     $                  CALL SLARTV( NRT, AB( KD-L, J1+L ), KD1*LDAB,
...
*                    elements which have been created outside the band
*
                     CALL SLARGV( NR, AB( KD1, J1-KD1 ), KD1*LDAB,
     $                            WORK( J1 ), KD1, D( J1 ), KD1 )
*
...
*
                  DO 110 L = 1, KD - 1
                     ...
                     END IF
                     IF( NRT.GT.0 )
     $                  CALL SLARTV( NRT, AB( L+2, J1-1 ), KD1*LDAB,
