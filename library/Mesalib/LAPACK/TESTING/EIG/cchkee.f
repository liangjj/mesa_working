...
*      Test CHETRD, CUNGTR, CSTEQR, CSTERF, and CSTEIN
*
...
*      Test CHEGST, CHEGV, CHPGST, and CHPGV
*
...
*  3-character path names in columns 1-3 (except for CBL and CBK; see
...
*
*  line 1:  'CGEBAL' in columns 1-6 to test CGEBAL, or 'CGEBAK in
*           columns 1-6 to test CGEBAK.
*
...
*     ..
*     .. Local Scalars ..
      LOGICAL            CES, CEV, CGG, CHB, CSX, CVX, FATAL, GLM, GQR,
...
*     .. External Subroutines ..
      EXTERNAL           ALAREQ, CCHKBD, CCHKBK, CCHKBL, CCHKEC, CCHKGG,
     $                   CCHKHB, CCHKHS, CCHKST, CCKGLM, CCKGQR, CCKGSV,
     $                   CCKLSE, CDRVBD, CDRVES, CDRVEV, CDRVGG, CDRVSG,
     $                   CDRVST, CDRVSX, CDRVVX, CERRBD, CERRED, CERRGG,
     $                   CERRHS, CERRST, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          LEN, MIN
*     ..
...
*
      ...
      ELSE
*
*        Not NEP, SEP, SVD, CEV, CES, CVX, or CSX:
*        Test for one of the special paths.
*
         SUBNAM = LINE( 1: 6 )
         IF( LSAMEN( 6, SUBNAM, 'CGEBAL' ) ) THEN
*
*           CGEBAL:  Balancing
*
            CALL CCHKBL( NIN, NOUT )
         ELSE IF( LSAMEN( 6, SUBNAM, 'CGEBAK' ) ) THEN
*
