...
*     .. External Subroutines ..
     ...
     $                   DGEBRD, DGEMM, DLABAD, DLACPY, DLAHD2, DLATMR,
     $                   DLATMS, DLAZRO, DORGBR, DORT01, DSVDCH, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $         CALL DCOPY( MNMIN-1, BE, 1, WORK, 1 )
            ...
            CALL DLAZRO( MNMIN, MNMIN, ZERO, ONE, U, LDPT )
            CALL DLAZRO( MNMIN, MNMIN, ZERO, ONE, VT, LDPT )
*
