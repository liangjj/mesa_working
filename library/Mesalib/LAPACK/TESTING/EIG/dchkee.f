...
*      Test DSYTRD, DORGTR, DSTEQR, DSTERF, and DSTEIN.
*
...
*      Test DSYGST, DSYGV, DSPGST, and DSPGV
*
...
*  3-character path names in columns 1-3 (except for DBL and DBK; see
...
*
*  line 1:  'DGEBAL' in columns 1-6 to test DGEBAL, or 'DGEBAK in
*           columns 1-6 to test DGEBAK.
*
...
*     ..
*     .. Local Scalars ..
      LOGICAL            DES, DEV, DGG, DSB, DSX, DVX, FATAL, GLM, GQR,
...
*     .. External Subroutines ..
      EXTERNAL           ALAREQ, DCHKBD, DCHKBK, DCHKBL, DCHKEC, DCHKGG,
     $                   DCHKHS, DCHKSB, DCHKST, DCKGLM, DCKGQR, DCKGSV,
     $                   DCKLSE, DDRVBD, DDRVES, DDRVEV, DDRVGG, DDRVSG,
     $                   DDRVST, DDRVSX, DDRVVX, DERRBD, DERRED, DERRGG,
     $                   DERRHS, DERRST, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          LEN, MIN
*     ..
...
*
      ...
      ELSE
*
*        Not NEP, SEP, SVD, DEV, DES, DVX, or DSX:
*        Test for one of the special paths.
*
         SUBNAM = LINE( 1: 6 )
         IF( LSAMEN( 6, SUBNAM, 'DGEBAL' ) ) THEN
*
*           DGEBAL:  Balancing
*
            CALL DCHKBL( NIN, NOUT )
         ELSE IF( LSAMEN( 6, SUBNAM, 'DGEBAK' ) ) THEN
*
