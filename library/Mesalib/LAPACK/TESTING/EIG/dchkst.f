...
*          Workspace.
*
*  RESULT  (output) DOUBLE PRECISION array, dimension (21)
...
*     .. External Subroutines ..
      EXTERNAL           DCOPY, DLABAD, DLACPY, DLASUM, DLATMR, DLATMS,
     $                   DLAZRO, DOPGTR, DORGTR, DPTEQR, DSPT21, DSPTRD,
     $                   DSTEBZ, DSTECH, DSTEIN, DSTEQR, DSTERF, DSTT21,
     $                   DSYT21, DSYTRD, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $         CALL DCOPY( N-1, SE, 1, WORK, 1 )
            CALL DLAZRO( N, N, ZERO, ONE, Z, LDU )
*
            NTEST = 9
