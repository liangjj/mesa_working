...
*          Modified.
*
*  RESULT  DOUBLE PRECISION array, dimension (84)
...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DLABAD, DLACPY, DLAFTS, DLATMR, DLATMS,
     $                   DLAZRO, DSBEV, DSBEVX, DSPEV, DSPEVX, DSTEV,
     $                   DSTEVX, DSTT21, DSTT22, DSYEV, DSYEVX, DSYT21,
     $                   DSYT22, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               NTEST = NTEST + 1
               CALL DSYEV( 'V', UPLO, N, A, LDU, D1, WORK, NWORK,
     $                     IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               CALL DSYEV( 'N', UPLO, N, A, LDU, D3, WORK, NWORK,
     $                     IINFO )
               IF( IINFO.NE.0 ) THEN
