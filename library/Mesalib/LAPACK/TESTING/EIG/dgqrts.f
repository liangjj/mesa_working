...
*          by DGGQRF, see DGGQRF for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL           DGEMM, DGGQRF, DLACPY, DLAZRO, DORGQR, DORGRQ,
     $                   DSYRK
*     ..
*     .. Intrinsic Functions ..
...
*     Copy R
*
      CALL DLAZRO( N, M, ZERO, ZERO, R, LDA )
      CALL DLACPY( 'Upper', N, M, AF, LDA, R, LDA )
*
*     Copy T
*
      CALL DLAZRO( N, P, ZERO, ZERO, T, LDB )
      IF( N.LE.P ) THEN
