...
*      Test SSYTRD, SORGTR, SSTEQR, SSTERF, and SSTEIN.
*
...
*      Test SSYGST, SSYGV, SSPGST, and SSPGV
*
...
*  3-character path names in columns 1-3 (except for SBL and SBK; see
...
*
*  line 1:  'SGEBAL' in columns 1-6 to test SGEBAL, or 'SGEBAK in
*           columns 1-6 to test SGEBAK.
*
...
*     ..
*     .. Local Scalars ..
      LOGICAL            FATAL, GLM, GQR, GSV, LSE, NEP, SEP, SES, SEV,
     $                   SGG, SSB, SSX, SVD, SVX, TSTCHK, TSTDIF,
     $                   TSTDRV, TSTERR
      CHARACTER          C1
      CHARACTER*3        C3, PATH
...
*     .. External Subroutines ..
      EXTERNAL           ALAREQ, SCHKBD, SCHKBK, SCHKBL, SCHKEC, SCHKGG,
     $                   SCHKHS, SCHKSB, SCHKST, SCKGLM, SCKGQR, SCKGSV,
     $                   SCKLSE, SDRVBD, SDRVES, SDRVEV, SDRVGG, SDRVSG,
     $                   SDRVST, SDRVSX, SDRVVX, SERRBD, SERRED, SERRGG,
     $                   SERRHS, SERRST, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          LEN, MIN
*     ..
...
*
      ...
      ELSE
*
*        Not NEP, SEP, SVD, SEV, SES, SVX, or SSX:
*        Test for one of the special paths.
*
         SUBNAM = LINE( 1: 6 )
         IF( LSAMEN( 6, SUBNAM, 'SGEBAL' ) ) THEN
*
*           SGEBAL:  Balancing
*
            CALL SCHKBL( NIN, NOUT )
         ELSE IF( LSAMEN( 6, SUBNAM, 'SGEBAK' ) ) THEN
*
...
*
  ...
  270          CONTINUE
     ...
     $                      D( 1, 11 ), A( 1, 2 ), NMAX, A( 1, 3 ),
     $                      D( 1, 12 ), A( 1, 4 ), A( 1, 5 ), WORK,
