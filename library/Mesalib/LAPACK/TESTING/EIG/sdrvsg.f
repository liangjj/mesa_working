...
*  =======
*
*  SDRVSG checks the symmetric generalized eigenvalue problem routines.
*
*     SSYGST reduces a REAL generalized symmetric
...
*          Modified.
*
*  RESULT  REAL array, dimension (17)
...
*     .. External Subroutines ..
      EXTERNAL           SLABAD, SLACPY, SLAFTS, SLASUM, SLATMR, SLATMS,
     $                   SLAZRO, SSGT01, SSPGV, SSYGV, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
   90       CONTINUE
*
*           3)  Call SSYGV  or SSPGV  to compute S and U, do tests.
*
...
*
     ...
     $                         N, N, UPLO, B, LDB, WORK( N+1 ), IINFO )
                  ...
                  CALL SSYGV( IBTYPE, 'V', UPLO, N, V, LDU, B, LDB, D1,
     $                        WORK, NWORK, IINFO )
*
*                 Do Test
*
                  NTEST = 1
                  CALL SSGT01( IBTYPE, UPLO, N, A, LDA, BB, LDB, V, LDU,
     $                         D1, UZ, RESULT( 1 ) )
                  NTESTT = NTESTT + NTEST
                  CALL SLAFTS( 'SSG', N, N, JTYPE, NTEST, RESULT,
...
*
  ...
  130                CONTINUE
                  END IF
*
                  CALL SSPGV( IBTYPE, 'V', UPLO, N, UZ, U, D1, V, LDU,
     $                        WORK, IINFO )
*
*                 Do Test
*
...
*     Summary
*
      CALL SLASUM( 'SSG', NOUNIT, NERRS+NERRS2, NTESTT+NTEST2 )
*
