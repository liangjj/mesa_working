...
*  ZGESVD factors A = U diag(S) VT, where U and VT are unitary
...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, XERBLA, ZBDT01, ZGESVD, ZLACPY, ZLATMS,
     $                   ZLAZRO, ZUNT01, ZUNT03
*     ..
*     .. Intrinsic Functions ..
...
*              Zero matrix
*
               CALL ZLAZRO( M, N, CZERO, CZERO, A, LDA )
               DO 30 I = 1, MIN( M, N )
                  S( I ) = ZERO
   30          CONTINUE
*
...
*              Identity matrix
*
               CALL ZLAZRO( M, N, CZERO, CONE, A, LDA )
               DO 40 I = 1, MIN( M, N )
                  S( I ) = ONE
   40          CONTINUE
*
