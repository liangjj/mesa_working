...
*          The unitary matrix of eigenvectors computed by ZHEEV,
*          ZHEEVX, ZHPEV, CHPEVX, ZHBEV, and CHBEVX.
*          Modified.
*
...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DLABAD, DLAFTS, XERBLA, ZHBEV, ZHBEVX,
     $                   ZHEEV, ZHEEVX, ZHET21, ZHET22, ZHPEV, ZHPEVX,
     $                   ZLACPY, ZLATMR, ZLATMS, ZLAZRO
*     ..
*     .. Intrinsic Functions ..
...
*
            DO 940 IUPLO = 0, 1
               ...
               END IF
*
*              Call ZHEEV and CHEEVX.
*
               CALL ZLACPY( ' ', N, N, A, LDA, V, LDU )
*
               NTEST = NTEST + 1
               CALL ZHEEV( 'V', UPLO, N, A, LDU, D1, WORK, NWORK, RWORK,
     $                     IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               CALL ZHEEV( 'N', UPLO, N, A, LDU, D3, WORK, NWORK, RWORK,
     $                     IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 1
               CALL ZHPEV( 'V', UPLO, N, WORK, D1, Z, LDU, V, RWORK,
     $                     IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
               NTEST = NTEST + 2
               CALL ZHPEV( 'N', UPLO, N, WORK, D3, Z, LDU, V, RWORK,
     $                     IINFO )
               IF( IINFO.NE.0 ) THEN
