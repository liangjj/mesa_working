...
*     .. External Subroutines ..
      EXTERNAL           DLABAD, DLASUM, XERBLA, ZGET23, ZLATME, ZLATMR,
     $                   ZLATMS, ZLAZRO
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                      ZERO, ANORM, 'NO', A, LDA, IDUMMA, IINFO )
               IF( N.GE.4 ) THEN
                  CALL ZLAZRO( 2, N, CZERO, CZERO, A, LDA )
                  CALL ZLAZRO( N-3, 1, CZERO, CZERO, A( 3, 1 ), LDA )
                  CALL ZLAZRO( N-3, 2, CZERO, CZERO, A( 3, N-1 ), LDA )
                  CALL ZLAZRO( 1, N, CZERO, CZERO, A( N, 1 ), LDA )
               END IF
*
