...
*     .. External Subroutines ..
      EXTERNAL           ALAREQ, CCHKEQ, CCHKGB, CCHKGE, CCHKGT,
     $                   CCHKHE, CCHKHP, CCHKLQ, CCHKPB, CCHKPO,
     $                   CCHKPP, CCHKPT, CCHKQL, CCHKQP, CCHKQR, CCHKRQ,
...
*
      ...
      DO 30 I = 1, NNS
         ...
         ELSE IF( NSVAL( I ).GT.NMAX ) THEN
            WRITE( NOUT, FMT = 9995 )'NRHS', NSVAL( I ), NMAX
            FATAL = .TRUE.
         END IF
   30 CONTINUE
      IF( NNS.GT.0 )
...
*
 ...
 9993 FORMAT( ' Tests of the COMPLEX LAPACK routines ',
     $      / ' LAPACK VERSION 1.1, released March 31, 1993 ',
 ...
 9986 FORMAT( / ' LAPACK VERSION 1.1, released March 31, 1993 ' )
*
*     End of CCHKAA
*
      END
