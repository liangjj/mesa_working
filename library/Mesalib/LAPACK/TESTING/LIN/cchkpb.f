...
*     .. External Functions ..
      ...
      EXTERNAL           CLANGE, CLANSB, SGET06
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASUM, CCOPY, CERRPO, CGET04,
     $                   CLACPY, CLARHS, CLATB4, CLATMS, CLAZRO, CPBCON,
     $                   CPBRFS, CPBT01, CPBT02, CPBT05, CPBTRF, CPBTRS,
     $                   CSWAP, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                     CALL CLAZRO( N, N, CMPLX( ZERO ), CMPLX( ONE ),
     $                            AINV, LDA )
                     SRNAMT = 'CPBTRS'
...
*
                     ANORM = CLANSB( '1', UPLO, N, KD, A, LDAB, RWORK )
