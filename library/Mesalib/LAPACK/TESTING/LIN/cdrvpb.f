...
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               CLANGE, CLANSB, SGET06
      EXTERNAL           LSAME, CLANGE, CLANSB, SGET06
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, CCOPY, CERRVX, CGET04,
     $                   CLACPY, CLAQSB, CLARHS, CLASET, CLATB4, CLATMS,
     $                   CLAZRO, CPBEQU, CPBSV, CPBSVX, CPBT01, CPBT02,
...
*
                                 CALL CLAQSB( UPLO, N, KD, AFAC, LDAB,
     $                                        S, SCOND, AMAX, EQUED )
                              END IF
                           END IF
*
...
*
                           ANORM = CLANSB( '1', UPLO, N, KD, AFAC, LDAB,
     $                             RWORK )
*
*                          Factor the matrix A.
*
...
*                          EQUED='Y'
*
                           CALL CLAQSB( UPLO, N, KD, A, LDAB, S, SCOND,
     $                                  AMAX, EQUED )
                        END IF
*
