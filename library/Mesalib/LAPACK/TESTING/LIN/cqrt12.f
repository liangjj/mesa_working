...
*          max(M,N).
*
*  RWORK   (workspace) REAL array, dimension (2*min(M,N))
*
*  =====================================================================
*
*     .. Parameters ..
...
*     .. External Subroutines ..
      EXTERNAL           CGEBD2, CLASCL, CLAZRO, SAXPY, SBDSQR, SLABAD,
     $                   SLASCL, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL CLAZRO( M, N, CMPLX( ZERO ), CMPLX( ZERO ), WORK, M )
      DO 20 J = 1, N
         DO 10 I = 1, MIN( J, M )
            WORK( ( J-1 )*M+I ) = A( I, J )
   10    CONTINUE
...
*
     ...
     $                DUMMY, MN, DUMMY, 1, DUMMY, MN, DUMMY, INFO )
*
         IF( ISCL.EQ.1 ) THEN
