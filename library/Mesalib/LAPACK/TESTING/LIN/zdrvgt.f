...
*
                  ANORMO = ZLANGT( '1', N, A, A( N ), A( 2*N ) )
                  ANORMI = ZLANGT( 'I', N, A, A( N ), A( 2*N ) )
*
*                 Factor the matrix A.
*
                  CALL ZGTTRF( N, AF, AF( N ), AF( 2*N ), AF( 3*N-1 ),
     $                         IWORK, INFO )
*
...
*
   ...
   30                CONTINUE
                     X( I ) = ONE
                     CALL ZGTTRS( 'No transpose', N, 1, AF, AF( N ),
...
*
                     SRNAMT = 'ZGTSV '
                     CALL ZGTSV( N, NRHS, AF, AF( N ), AF( 2*N ), X,
     $                           LDA, INFO )
*
...
*
     ...
     $                               LDA )
                        CALL ZGTT02( TRANS, N, NRHS, A, A( N ),
...
*
                  SRNAMT = 'ZGTSVX'
                  CALL ZGTSVX( FACT, TRANS, N, NRHS, A, A( N ),
...
*                    residual.
*
                     CALL ZGTT01( N, A, A( N ), A( 2*N ), AF, AF( N ),
...
*
                     ...
                     CALL ZGTT02( TRANS, N, NRHS, A, A( N ), A( 2*N ),
...
*
                     CALL ZGTT05( TRANS, N, NRHS, A, A( N ), A( 2*N ),
