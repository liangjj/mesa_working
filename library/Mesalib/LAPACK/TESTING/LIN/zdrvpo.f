...
*     .. External Functions ..
      ...
      EXTERNAL           LSAME, DGET06, ZLANSY
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, XLAENV, ZERRVX, ZGET04,
     $                   ZLACPY, ZLAQSY, ZLARHS, ZLASET, ZLATB4, ZLATMS,
     $                   ZPOEQU, ZPOSV, ZPOSVX, ZPOT01, ZPOT02, ZPOT05,
     $                   ZPOTRF, ZPOTRI
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
                              CALL ZLAQSY( UPLO, N, AFAC, LDA, S, SCOND,
     $                                     AMAX, EQUED )
                           END IF
                        END IF
*
...
*
                        ANORM = ZLANSY( '1', UPLO, N, AFAC, LDA, RWORK )
*
*                       Factor the matrix A.
*
...
*
                        AINVNM = ZLANSY( '1', UPLO, N, A, LDA, RWORK )
...
*                       EQUED='Y'.
*
                        CALL ZLAQSY( UPLO, N, A, LDA, S, SCOND, AMAX,
     $                               EQUED )
                     END IF
*
