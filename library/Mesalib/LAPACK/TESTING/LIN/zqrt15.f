...
*     .. External Subroutines ..
     ...
     $                   ZLARF, ZLARNV, ZLAROR, ZLASCL, ZLAZRO
*     ..
*     .. Intrinsic Functions ..
...
*
         ...
         CALL ZLAZRO( M, RANK, CZERO, CONE, A, LDA )
...
*
   ...
   40    CONTINUE
         IF( RANK.LT.N )
     $      CALL ZLAZRO( M, N-RANK, CZERO, CZERO, A( 1, RANK+1 ), LDA )
...
*
   ...
   50    CONTINUE
         ...
         CALL ZLAZRO( M, NRHS, CZERO, CZERO, B, LDB )
*
      END IF
*
*     Scale the matrix
