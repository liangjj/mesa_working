...
*     .. External Subroutines ..
      EXTERNAL           ZGEMM, ZGERQF, ZHERK, ZLACPY, ZLAZRO, ZUNGRQ
*     ..
*     .. Intrinsic Functions ..
...
*     Copy details of Q
*
      CALL ZLAZRO( N, N, ROGUE, ROGUE, Q, LDA )
      IF( M.LE.N ) THEN
...
*     Copy R
*
      CALL ZLAZRO( M, N, DCMPLX( ZERO ), DCMPLX( ZERO ), R, LDA )
      IF( M.LE.N ) THEN
         IF( M.GT.0 )
...
*     Compute I - Q*Q'
*
      CALL ZLAZRO( N, N, DCMPLX( ZERO ), DCMPLX( ONE ), R, LDA )
