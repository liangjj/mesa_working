...
*     .. Parameters ..
      ...
      PARAMETER          ( ZERO = 0.0D0, ONE = 1.0D0, TOOSML = 1.0D-20 )
      COMPLEX*16         CZERO, CONE
      PARAMETER          ( CZERO = 0.0D0, CONE = 1.0D0 )
*     ..
*     .. Local Scalars ..
      INTEGER            I, IROW, ITYPE, IXFRM, J, JCOL, KBEG, NXFRM
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZGEMV, ZGERC, ZLACGV, ZSCAL
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          ABS, DCMPLX, DCONJG, MIN
*     ..
