...
c
      ...
      character*32 site
      character*16 user
      data curver/' mesa(2.0);5/30/2014;unix.'/
      data copyr/'     (c) 1990, the university of california.'/
      data site /'National Institute for Standards and Technolgy;'/
c
c
 1000 format(a80)
 1020 format(a80,/)
 1010 format(5x,80a1)
     ...
     $              'M. Page and B. Schneider.'
      mch(1) = 'feynman.cam.nist.gov'
      mch(2) = 'stampede.tacc.utexas.edu'
      mch(3) = 'gordon.sdsc.edu'
      mchtyp(1) = '16 core 3.1 GHz Sandy Bridge Tower Workstation'
      mchtyp(2) = 'Stampede XSEDE Cluster at TACC'
      mchtyp(3) = 'Gordon XSEDE Cluster at SDSC'
c
