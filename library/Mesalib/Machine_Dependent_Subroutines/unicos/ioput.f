...
c     disk is considered to be 1. also note that getwa and putwa expect
c     an argument which is the file name, not the unit number which is
c     passed in variable file.  
