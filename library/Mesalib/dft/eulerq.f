*deck @(#)eulerq.f	5.2 2/5/95
      subroutine eulerq(p,w,n,alpha)
c***begin prologue     eulerq.f
...
c         i=n, so reflect this in the points and weights returned.
      do 10 i=1,n-1
         p(i)=alpha*float(i*i)/float((n-i)*(n-i))
