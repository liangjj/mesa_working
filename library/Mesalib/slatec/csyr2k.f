*deck csyr2k
     ...
     $   c, ldc)
c***begin prologue  csyr2k
c***purpose  perform symmetric rank 2k update of a complex symmetric
c            matrix.
c***library   slatec (blas)
c***category  d1b6
c***type      complex (ssyr2-s, dsyr2-d, csyr2-c, csyr2k-c)
...
c***first executable statement  csyr2k
c
