*deck strmm
     ...
     $   b, ldb)
c***begin prologue  strmm
c***purpose  multiply a real general matrix by a real triangular matrix.
c***library   slatec (blas)
c***category  d1b6
c***type      single precision (strmm-s, dtrmm-d, ctrmm-c)
...
c***first executable statement  strmm
c
