...
*     .. External Subroutines ..
     ...
     $                   CLASCL, CLAZRO, CTGEVC, CUNGQR, CUNMQR, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               CLANGE, SLAMCH
...
*
      IF( ILVL ) THEN
         CALL CLAZRO( N, N, CZERO, CONE, VL, LDVL )
...
*
      IF( ILVR )
     $   CALL CLAZRO( N, N, CZERO, CONE, VR, LDVR )
*
...
*
         ...
         END IF
*
         CALL CTGEVC( 'B', CHTEMP, LDUMMA, N, A, LDA, B, LDB, VL,
     $                LDVL, VR, LDVR, N, IN, WORK( IWORK ),
     $                RWORK( IRWORK ), IINFO )
         IF( IINFO.NE.0 ) THEN
            INFO = N + 7
            GO TO 80
