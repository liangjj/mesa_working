...
*  matrix, B is a given N-by-P matrix, and d is given N vector.  It is
*  also assumed that M <= N <= M+P and
*
...
*
*  LWORK   (input) INTEGER
*          The dimension fo the array WORK. LWORK >= M+P+max(N,M,P).
...
*     y = Z'*y
*
      CALL CUNMRQ( 'Left', 'Conjugate transpose', P, 1, MIN( P, N ),
