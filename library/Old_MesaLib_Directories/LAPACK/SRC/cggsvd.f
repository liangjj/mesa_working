...
*  of the M-by-N complex matrix A and P-by-N complex matrix B:
*
*        U'*A*Q = D1*( 0 R ),    V'*B*Q = D2*( 0 R )               (1)
*
*  where U, V and Q are unitary matrices, R is an upper triangular
*  matrix, and Z' means the conjugate transpose of Z.  Let K+L = the
*  numerical effective rank of the matrix (A',B')', then D1 and D2 are
...
*          If JOBU = 'V', V contains the P-by-P unitary matrix V.
...
*          If JOBU = 'Q', Q contains the N-by-N unitary matrix Q.
