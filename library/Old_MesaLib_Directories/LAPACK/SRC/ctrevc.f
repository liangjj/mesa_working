...
*  =======
*
*  CTREVC computes all or some right and/or left eigenvectors of a
...
*  of an original matrix A = Q*T*Q**H, then Q*X and/or Q*Y are the
...
*     .. Parameters ..
      ...
      PARAMETER          ( CMZERO = 0.0E+0, CMONE = 1.0E+0 )
*     ..
*     .. Local Scalars ..
