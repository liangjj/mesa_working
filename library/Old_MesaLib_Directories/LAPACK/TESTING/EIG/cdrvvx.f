...
*     .. External Subroutines ..
      EXTERNAL           CGET23, CLATME, CLATMR, CLATMS, CLAZRO, SLABAD,
     $                   SLASUM, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                      ZERO, ANORM, 'NO', A, LDA, IDUMMA, IINFO )
               IF( N.GE.4 ) THEN
                  CALL CLAZRO( 2, N, CZERO, CZERO, A, LDA )
                  CALL CLAZRO( N-3, 1, CZERO, CZERO, A( 3, 1 ), LDA )
                  CALL CLAZRO( N-3, 2, CZERO, CZERO, A( 3, N-1 ), LDA )
                  CALL CLAZRO( 1, N, CZERO, CZERO, A( N, 1 ), LDA )
               END IF
*
