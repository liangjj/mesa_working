...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CGGRQF, CLACPY, CLAZRO, CUNGQR,
     $                   CUNGRQ, CHERK
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL CLAZRO( N, N, CROGUE, CROGUE, Q, LDA )
      IF( M.LE.N ) THEN
...
*
      CALL CLAZRO( P, P, CROGUE, CROGUE, Z, LDB )
      IF( P.GT.1 )
...
*     Copy R
*
      CALL CLAZRO( M, N, CZERO, CZERO, R, LDA )
      IF( M.LE.N )THEN
...
*     Copy T
*
      CALL CLAZRO( P, N, CZERO, CZERO, T, LDB )
...
*     Compute I - Q*Q'
*
      CALL CLAZRO( N, N, CZERO, CONE, R, LDA )
...
*     Compute I - Z'*Z
*
      CALL CLAZRO( P, P, CZERO, CONE, T, LDB )
