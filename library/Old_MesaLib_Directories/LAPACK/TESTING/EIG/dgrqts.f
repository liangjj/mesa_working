...
*          by DGGRQF, see DGGRQF for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL           DGEMM, DGGRQF, DLACPY, DLAZRO, DORGQR, DORGRQ,
     $                   DSYRK
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL DLAZRO( N, N, ROGUE, ROGUE, Q, LDA )
      IF( M.LE.N ) THEN
...
*
      CALL DLAZRO( P, P, ROGUE, ROGUE, Z, LDB )
      IF( P.GT.1 )
...
*     Copy R
*
      CALL DLAZRO( M, N, ZERO, ZERO, R, LDA )
      IF( M.LE.N ) THEN
...
*     Copy T
*
      CALL DLAZRO( P, N, ZERO, ZERO, T, LDB )
...
*     Compute I - Q*Q'
*
      CALL DLAZRO( N, N, ZERO, ONE, R, LDA )
...
*     Compute I - Z'*Z
*
      CALL DLAZRO( P, P, ZERO, ONE, T, LDB )
