...
*     .. External Subroutines ..
     ...
     $                   SGEBRD, SGEMM, SLABAD, SLACPY, SLAHD2, SLATMR,
     $                   SLATMS, SLAZRO, SORGBR, SORT01, SSVDCH, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $         CALL SCOPY( MNMIN-1, BE, 1, WORK, 1 )
            ...
            CALL SLAZRO( MNMIN, MNMIN, ZERO, ONE, U, LDPT )
            CALL SLAZRO( MNMIN, MNMIN, ZERO, ONE, VT, LDPT )
*
