...
*          Workspace.
*
*  RESULT  (output) REAL array, dimension (21)
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SLABAD, SLACPY, SLASUM, SLATMR, SLATMS,
     $                   SLAZRO, SOPGTR, SORGTR, SPTEQR, SSPT21, SSPTRD,
     $                   SSTEBZ, SSTECH, SSTEIN, SSTEQR, SSTERF, SSTT21,
     $                   SSYT21, SSYTRD, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $         CALL SCOPY( N-1, SE, 1, WORK, 1 )
            CALL SLAZRO( N, N, ZERO, ONE, Z, LDU )
*
            NTEST = 9
