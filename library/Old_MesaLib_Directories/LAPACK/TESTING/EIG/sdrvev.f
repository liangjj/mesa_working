...
*
     ...
     $                      ZERO, ANORM, 'NO', A, LDA, IWORK, IINFO )
               IF( N.GE.4 ) THEN
                  CALL SLAZRO( 2, N, ZERO, ZERO, A, LDA )
                  CALL SLAZRO( N-3, 1, ZERO, ZERO, A( 3, 1 ), LDA )
                  CALL SLAZRO( N-3, 2, ZERO, ZERO, A( 3, N-1 ), LDA )
                  CALL SLAZRO( 1, N, ZERO, ZERO, A( N, 1 ), LDA )
               END IF
*
