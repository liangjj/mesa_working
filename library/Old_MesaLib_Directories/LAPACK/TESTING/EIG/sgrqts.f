...
*     .. External Subroutines ..
      EXTERNAL           SGEMM, SGGRQF, SLACPY, SLAZRO, SORGQR,
     $                   SORGRQ, SSYRK
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL SLAZRO( N, N, ROGUE, ROGUE, Q, LDA )
      IF( M.LE.N ) THEN
...
*
      CALL SLAZRO( P, P, ROGUE, ROGUE, Z, LDB )
      IF( P.GT.1 )
...
*     Copy R
*
      CALL SLAZRO( M, N, ZERO, ZERO, R, LDA )
      IF( M.LE.N )THEN
...
*     Copy T
*
      CALL SLAZRO( P, N, ZERO, ZERO, T, LDB )
...
*     Compute I - Q*Q'
*
      CALL SLAZRO( N, N, ZERO, ONE, R, LDA )
...
*     Compute I - Z'*Z
*
      CALL SLAZRO( P, P, ZERO, ONE, T, LDB )
