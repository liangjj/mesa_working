...
*  =======
*
*  ZDRVSG checks the complex hermitian generalized eigenvalue problem
*  routines.
*
*     ZHEGST reduces a COMPLEX*16 generalized Hermitian eigenproblem,
...
*
*     ZHETRD factors A as  U S U* , where * means conjugate
...
*
*     ZSTEIN computes Y, the eigenvectors of S, given the eigenvalues.
*
...
*          Modified.
*
*  Y       COMPLEX*16 array, dimension (LDU, max(NN))
*          The unitary matrix of eigenvectors computed by ZSTEIN.
...
*          Modified.
*
*  RESULT  DOUBLE PRECISION array, dimension (12)
...
*          -21: NWORK too small.
*          If  ZLATMR, CLATMS, ZHETRD, ZSTEQR, or DSTERF
...
*     .. External Subroutines ..
      EXTERNAL           DLABAD, DLAFTS, DLASUM, XERBLA, ZHEGV, ZHPGV,
     $                   ZLACPY, ZLATMR, ZLATMS, ZLAZRO, ZSGT01
*     ..
*     .. Intrinsic Functions ..
...
*
   80       CONTINUE
*
*           3)      Call ZHEGV  and ZHPGV  to compute S and U, do tests.
*
...
*
     ...
     $                         IINFO )
                  ...
                  CALL ZHEGV( IBTYPE, 'V', UPLO, N, V, LDU, B, LDB, D1,
     $                        WORK, NWORK, RWORK, IINFO )
*
*                 Do Test
*
                  NTEST = 1
                  CALL ZSGT01( IBTYPE, UPLO, N, A, LDA, BB, LDB, V, LDU,
     $                         D1, UZ, RWORK, RESULT( 1 ) )
                  NTESTT = NTESTT + NTEST
                  CALL DLAFTS( 'ZSG', N, N, JTYPE, NTEST, RESULT,
...
*
  ...
  120                CONTINUE
                  END IF
*
                  CALL ZHPGV( IBTYPE, 'V', UPLO, N, UZ, U, D1, V, LDU,
     $                        WORK, RWORK, IINFO )
*
*                 Do Test
*
...
*     Summary
*
      CALL DLASUM( 'ZSG', NOUNIT, NERRS+NERRS2, NTESTT+NTEST2 )
*
