...
*          by ZGGQRF, see ZGGQRF for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL           ZGEMM, ZGGQRF, ZHERK, ZLACPY, ZLAZRO, ZUNGQR,
     $                   ZUNGRQ
*     ..
*     .. Intrinsic Functions ..
...
*     Copy R
*
      CALL ZLAZRO( N, M, CZERO, CZERO, R, LDA )
      CALL ZLACPY( 'Upper', N, M, AF, LDA, R, LDA )
*
*     Copy T
*
      CALL ZLAZRO( N, P, CZERO, CZERO, T, LDB )
      IF( N.LE.P ) THEN
...
*     Compute I - Q'*Q
*
      CALL ZLAZRO( N, N, CZERO, CONE, R, LDA )
...
*     Compute I - Z'*Z
*
      CALL ZLAZRO( P, P, CZERO, CONE, T, LDB )
