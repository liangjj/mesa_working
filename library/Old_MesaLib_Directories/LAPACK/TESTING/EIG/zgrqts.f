...
*          by ZGGRQF, see ZGGRQF for further details.
*
...
*     .. External Subroutines ..
      EXTERNAL           ZGEMM, ZGGRQF, ZHERK, ZLACPY, ZLAZRO, ZUNGQR,
     $                   ZUNGRQ
*     ..
*     .. Intrinsic Functions ..
...
*     Copy R
*
      CALL ZLAZRO( M, N, CZERO, CZERO, R, LDA )
      IF( M.LE.N ) THEN
...
*     Copy T
*
      CALL ZLAZRO( P, N, CZERO, CZERO, T, LDB )
