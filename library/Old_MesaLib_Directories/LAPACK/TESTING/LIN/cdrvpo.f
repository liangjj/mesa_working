...
*     .. External Functions ..
      LOGICAL            LSAME
      REAL               CLANSY, SGET06
      EXTERNAL           LSAME, CLANSY, SGET06
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALADHD, ALAERH, ALASVM, CERRVX, CGET04, CLACPY,
     $                   CLAQSY, CLARHS, CLASET, CLATB4, CLATMS, CPOEQU,
     $                   CPOSV, CPOSVX, CPOT01, CPOT02, CPOT05, CPOTRF,
     $                   CPOTRI, XLAENV
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
...
*
                              CALL CLAQSY( UPLO, N, AFAC, LDA, S, SCOND,
     $                                     AMAX, EQUED )
                           END IF
                        END IF
*
...
*
                        ANORM = CLANSY( '1', UPLO, N, AFAC, LDA, RWORK )
*
*                       Factor the matrix A.
*
...
*
                        AINVNM = CLANSY( '1', UPLO, N, A, LDA, RWORK )
...
*                       EQUED='Y'.
*
                        CALL CLAQSY( UPLO, N, A, LDA, S, SCOND, AMAX,
     $                               EQUED )
                     END IF
*
