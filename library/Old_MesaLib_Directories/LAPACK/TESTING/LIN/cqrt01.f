...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CGEQRF, CHERK, CLACPY, CLAZRO, CUNGQR
*     ..
*     .. Intrinsic Functions ..
...
*     Copy details of Q
*
      CALL CLAZRO( M, M, ROGUE, ROGUE, Q, LDA )
...
*     Copy R
*
      CALL CLAZRO( M, N, CMPLX( ZERO ), CMPLX( ZERO ), R, LDA )
...
*     Compute I - Q'*Q
*
      CALL CLAZRO( M, M, CMPLX( ZERO ), CMPLX( ONE ), R, LDA )
