...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CLARF, CLARNV, CLAROR, CLASCL, CLAZRO,
...
*
         ...
         CALL CLAZRO( M, RANK, CZERO, CONE, A, LDA )
...
*
   ...
   40    CONTINUE
         IF( RANK.LT.N )
     $      CALL CLAZRO( M, N-RANK, CZERO, CZERO, A( 1, RANK+1 ), LDA )
...
*
         DO 50 J = 1, MN
            S( J ) = ZERO
   50    CONTINUE
         CALL CLAZRO( M, N, CZERO, CZERO, A, LDA )
         CALL CLAZRO( M, NRHS, CZERO, CZERO, B, LDB )
*
      END IF
*
*     Scale the matrix
