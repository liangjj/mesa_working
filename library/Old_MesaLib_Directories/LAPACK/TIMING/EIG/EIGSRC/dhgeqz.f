...
*          entries of A that would result from reducing A and B to
...
*          BETA(1:N) will be set to the (real) diagonal entries of B
...
*
            ...
            SQI = SQI / T
*
*           Compute diagonal entries of QBZ
*
...
*
*              All but last entries: use 3x3 Householder transforms.
*
...
*
  ...
  290       CONTINUE
*
*           Last entries: Use Givens rotations
*
