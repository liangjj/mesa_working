...
*  triangular.  More precisely, ZGGHRD simultaneously decomposes  A
...
*
*  ZGGHRD implements an unblocked form of the method, there being no
...
*     .. Parameters ..
      ...
      PARAMETER          ( CONE = 1.0D+0, CZERO = 0.0D+0 )
*     ..
*     .. Local Scalars ..
      LOGICAL            ILQ, ILZ
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZLARTG, ZLAZRO, ZROT
*     ..
*     .. Intrinsic Functions ..
