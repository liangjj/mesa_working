...
*     ..
*     .. External Functions ..
      DOUBLE PRECISION   DLAMCH, DLARND, DOPLA, DSECND, SOPLA2
      EXTERNAL           DLAMCH, DLARND, DOPLA, DSECND, SOPLA2
*     ..
*     .. External Subroutines ..
      EXTERNAL           ATIMIN, DBDSQR, DCOPY, DGEBRD, DLACPY, DLATMR,
     $                   DLATMS, DLAZRO, DORGBR, DPRTBV, DSVDC, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*
                     ...
                     S1 = DSECND( )
  190                CONTINUE
                     CALL DLAZRO( M, MINMN, ONE, TWO, U, LDA )
                     CALL DCOPY( MINMN, D, 1, WORK, 1 )
                     CALL DCOPY( MINMN-1, E, 1, WORK( MINMN+1 ), 1 )
...
*
                     ...
                     S1 = DSECND( )
  230                CONTINUE
                     CALL DLAZRO( MINMN, N, ONE, TWO, VT, LDA )
                     CALL DCOPY( MINMN, D, 1, WORK, 1 )
                     CALL DCOPY( MINMN-1, E, 1, WORK( MINMN+1 ), 1 )
...
*
                     ...
                     S1 = DSECND( )
  310                CONTINUE
                     CALL DLAZRO( MINMN, MINMN, ONE, TWO, U, LDA )
                     CALL DCOPY( MINMN, D, 1, WORK, 1 )
                     CALL DCOPY( MINMN-1, E, 1, WORK( MINMN+1 ), 1 )
...
*
     ...
     $               TIMES( IPAR, ITYPE, IN, 3 )
                  OPCNTS( IPAR, ITYPE, IN, 8 ) = SOPLA2( 'DORGBR', 'Q',
...
*
     ...
     $               ZERO ) / DBLE( IC ) + TIMES( IPAR, ITYPE, IN, 1 ) +
     $               TIMES( IPAR, ITYPE, IN, 3 )
                  OPCNTS( IPAR, ITYPE, IN, 9 ) = SOPLA2( 'DORGBR', 'Q',
...
*
     ...
     $               TIMES( IPAR, ITYPE, IN, 4 )
                  OPCNTS( IPAR, ITYPE, IN, 10 ) = SOPLA2( 'DORGBR', 'P',
...
*
     ...
     $               TIMES( IPAR, ITYPE, IN, 5 )
                  OPCNTS( IPAR, ITYPE, IN, 11 ) = SOPLA2( 'DORGBR', 'Q',
     $               M, MINMN, KU, 0, NB ) + SOPLA2( 'DORGBR', 'P', N,
