...
*     .. Parameters ..
      ...
      PARAMETER          ( CONE = 1.0D0, CTWO = 2.0D0 )
*     ..
*     .. Local Scalars ..
...
*     .. External Functions ..
      ...
      COMPLEX*16         ZLARND
      EXTERNAL           DLAMCH, DLARND, DOPLA, DSECND, SOPLA2, ZLARND
*     ..
*     .. External Subroutines ..
      EXTERNAL           ATIMIN, DCOPY, DPRTBV, XLAENV, ZBDSQR, ZGEBRD,
     $                   ZLACPY, ZLATMR, ZLATMS, ZLAZRO, ZSVDC, ZUNGBR
*     ..
*     .. Intrinsic Functions ..
...
*
                     ...
                     S1 = DSECND( )
  190                CONTINUE
                     CALL ZLAZRO( M, MINMN, CONE, CTWO, U, LDA )
                     CALL DCOPY( MINMN, D, 1, RWORK, 1 )
                     CALL DCOPY( MINMN-1, E, 1, RWORK( MINMN+1 ), 1 )
...
*
                     ...
                     S1 = DSECND( )
  230                CONTINUE
                     CALL ZLAZRO( MINMN, N, CONE, CTWO, VT, LDA )
                     CALL DCOPY( MINMN, D, 1, RWORK, 1 )
                     CALL DCOPY( MINMN-1, E, 1, RWORK( MINMN+1 ), 1 )
...
*
                     ...
                     S1 = DSECND( )
  310                CONTINUE
                     CALL ZLAZRO( MINMN, MINMN, CONE, CTWO, U, LDA )
                     CALL DCOPY( MINMN, D, 1, RWORK, 1 )
                     CALL DCOPY( MINMN-1, E, 1, RWORK( MINMN+1 ), 1 )
...
*
     ...
     $               TIMES( IPAR, ITYPE, IN, 3 )
                  OPCNTS( IPAR, ITYPE, IN, 8 ) = SOPLA2( 'ZUNGBR', 'Q',
...
*
     ...
     $               ZERO ) / DBLE( IC ) + TIMES( IPAR, ITYPE, IN, 1 ) +
     $               TIMES( IPAR, ITYPE, IN, 3 )
                  OPCNTS( IPAR, ITYPE, IN, 9 ) = SOPLA2( 'ZUNGBR', 'Q',
...
*
     ...
     $               TIMES( IPAR, ITYPE, IN, 4 )
                  OPCNTS( IPAR, ITYPE, IN, 10 ) = SOPLA2( 'ZUNGBR', 'P',
...
*
     ...
     $               TIMES( IPAR, ITYPE, IN, 5 )
                  OPCNTS( IPAR, ITYPE, IN, 11 ) = SOPLA2( 'ZUNGBR', 'Q',
     $               M, MINMN, KU, 0, NB ) + SOPLA2( 'ZUNGBR', 'P', N,
