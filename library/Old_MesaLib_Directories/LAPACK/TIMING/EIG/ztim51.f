...
*          10: ZTGEVC(JOB='A', SIDE='L')               'CTGEVC(A,L)'
*          11: ZTGEVC(JOB='B', SIDE='L')               'CTGEVC(B,L)'
*          12: ZTGEVC(JOB='A', SIDE='R')               'CTGEVC(A,R)'
*          13: ZTGEVC(JOB='B', SIDE='R')               'CTGEVC(B,R)'
...
*     .. External Subroutines ..
      EXTERNAL           ATIMIN, CQZHES, CQZVAL, CQZVEC, DLACPY, DLAZRO,
...
*     .. Data statements ..
     ...
     $                   'ZTGEVC(A,L)', 'ZTGEVC(B,L)', 'ZTGEVC(A,R)',
     $                   'ZTGEVC(B,R)', 'CQZHES(F)', 'CQZHES(T)',
...
*
                     IF( TIMSUB( 10 ) ) THEN
                        ...
                        S1 = DSECND( )
  550                   CONTINUE
                        CALL ZTGEVC( 'A', 'L', LLWORK, N, A, LDA, B,
...
*
  ...
  560                   CONTINUE
                        ...
                        CALL ZTGEVC( 'B', 'L', LLWORK, N, A, LDA, B,
     $                               LDA, H, LDA, T, LDA, N, ITEMP,
     $                               WORK, RWORK, IINFO )
                        IF( IINFO.NE.0 ) THEN
...
*
                     IF( TIMSUB( 12 ) ) THEN
                        ...
                        S1 = DSECND( )
  580                   CONTINUE
                        CALL ZTGEVC( 'A', 'R', LLWORK, N, A, LDA, B,
     $                               LDA, H, LDA, T, LDA, N, ITEMP,
     $                               WORK, RWORK, IINFO )
                        IF( IINFO.NE.0 ) THEN
...
*
  ...
  590                   CONTINUE
                        ...
                        CALL ZTGEVC( 'B', 'R', LLWORK, N, A, LDA, B,
     $                               LDA, H, LDA, T, LDA, N, ITEMP,
     $                               WORK, RWORK, IINFO )
                        IF( IINFO.NE.0 ) THEN
...
*
  ...
  820                CONTINUE
                     ...
                     CALL DLACPY( 'Full', N, N, TR, LDH, BR, LDA )
                     CALL DLACPY( 'Full', N, N, TI, LDH, BI, LDA )
                     CALL DLAZRO( N, N, ZERO, ONE, QR, LDA )
                     CALL DLAZRO( N, N, ZERO, ONE, QI, LDA )
                     CALL CQZVAL( LDA, N, AR, AI, BR, BI, ZERO, WR,
...
*
                     ...
                     DO 830 J = 1, IC
                        ...
                        CALL DLACPY( 'Full', N, N, TR, LDH, ZR, LDA )
                        CALL DLACPY( 'Full', N, N, TI, LDH, ZI, LDA )
                        CALL DLAZRO( N, N, ZERO, ONE, ZR, LDA )
                        CALL DLAZRO( N, N, ZERO, ONE, ZI, LDA )
  830                CONTINUE
                     S2 = DSECND( )
                     UNTIME = S2 - S1
*
  ...
  840          CONTINUE
            ELSE IF( RUNQZ ) THEN
               ...
               CALL DLAZRO( N, N, ZERO, ONE, QR, N1 )
               CALL DLAZRO( N, N, ZERO, ONE, QI, N1 )
