*deck @(#)gaussp.f	1.1 9/9/91
      subroutine gaussp(ckind, n, alpha, beta, kpts, endpts, 
     1                  b, t, w, z, want)
c
...
c        z        eigenvectors if specified in call
c
...
c
      ...
      character *(*) ckind
      logical want
      dimension  b(n), t(n), w(n), endpts(2), z(n,*)
      common/io/inp,iout
...
801           w(i) = w(i)*h/3.d+00
          return
      endif

c
      call classp (ckind, n, alpha, beta, b, t, muzero)
c
