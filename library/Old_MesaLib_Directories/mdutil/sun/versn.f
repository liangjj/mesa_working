...
c
c  20 june     1993   rlm at lanl
c        system V unix;solaris 2.2  for sun sparc10 server.
...
c
      ...
      character site*32
      character*8 user
      data curver/' mesa(5.1);11/6/94;System V unix.'/
...
c
      data mch /'t12','vivaldi','water'/
      data mchtyp /'sun 4/280s','sun 4/280s','sun sparc10'/
