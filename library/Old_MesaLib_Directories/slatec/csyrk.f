...
c***begin prologue  csyrk
c***purpose  perform symmetric rank k update of a complex symmetric
c            matrix.
c***library   slatec (blas)
c***category  d1b6
c***type      complex (ssyrk-s, dsyrk-d, csyrk-c)
...
c***first executable statement  csyrk
c
