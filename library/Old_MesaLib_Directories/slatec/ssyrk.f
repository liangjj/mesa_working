...
c***begin prologue  ssyrk
c***purpose  perform symmetric rank k update of a real symmetric matrix.
c***library   slatec (blas)
c***category  d1b6
c***type      single precision (ssyrk-s, dsyrk-d, csyrk-c)
...
c***first executable statement  ssyrk
c
