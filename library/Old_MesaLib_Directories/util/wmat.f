*deck @(#)wmat.f	5.1  11/6/94
      subroutine wmat(a,nrows,ncols,rowlab,collab)
c***begin prologue     wmat.f
c***date written       yymmdd  
c***revision date      11/6/94      
c
c***keywords           
c***author             unknown
c***source             @(#)wmat.f	5.1   11/6/94
c***purpose            
c***description
c     
c    
...
c
c
      call matprt(a,nrows,ncols,nrows,ncols,1,1,rowlab,collab,0,eig,
     $           .false.)
c
c
      return
