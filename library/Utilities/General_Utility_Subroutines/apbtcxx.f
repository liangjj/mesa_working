*deck apbtcxx
      subroutine apbtcxx(a,b,c,ni,nk,nj,na,nb,nc)
c***begin prologue     apbtcxx
c***date written       850601  (yymmdd)
c***revision date      yymmdd  (yymmdd)
c***keywords           matrix, multiply, subtract
c***author             schneider, barry (lanl)
c***source             @(#)apbtcxx.f    5.1   8/04/89
c***purpose                                               t
c                      vectorized matrix operation:  a=a+b *c .
c***description
c                      call apbtcxx(a,b,c,ni,nk,nj,na,nb,nc)
