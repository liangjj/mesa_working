*deck @(#)ioread.f	5.1  11/6/94
      subroutine ioread(string,pos,nwords,array,rarray,offset,c1)
c
c***begin prologue     ioread
c***date written       850125   (yymmdd)
c***revision date      910818   (yymmdd)
c   18 august   1991   bhl at lanl
c      changing this so that when writing one word at a time, it does
c      not store it in the constants table if the phrase 'without rewinding'
c      is in the string.
c***keywords           iosys dependent routines
c
c***author             saxe, paul,    (lanl)
c***source             @(#)ioread.f	5.1   11/6/94
