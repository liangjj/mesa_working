...
c
c***routines called    
c***end prologue       cuta2d
      subroutine cuta2d(resid,vec,u01,u02,t,n1,n2,m)
...
c      
         call cebtc(t,u02,resid(1,1,i),n2,n2,n1)
c
c        perform transformation on n1 variable
c
         call cebc(vec(1,1,i),t,u01,n2,n1,n1)
 10   continue   
      return
      end       
