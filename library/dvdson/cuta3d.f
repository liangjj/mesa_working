...
c                      
c***routines called    
c***end prologue       cuta3d
      subroutine cuta3d(resid,vec,u01,u02,u03,t1,t2,n1,n2,n3,m)
...
c         
            call cebtc(t1,u03,resid(1,1,j,i),n3,n3,n2)
            call cebc(t2(1,1,j),t1,u02,n3,n2,n2)
 20      continue
c
c        finish the transformation on n1 treating the vector as an
c        (n3*n2,n1) array.
c
         call cebc(vec(1,1,1,i),t2,u01,n3*n2,n1,n1)          
 10   continue   
      return
      end       
