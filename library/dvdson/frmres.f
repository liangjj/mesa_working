...
c***end prologue       frmres
      subroutine frmres(psi,vec,hvec,trmat,eig,etmp,scale,cnverg,resid,
     1                 maxerr,t1,t2,n,m,nroot,ncon,addvec,
     2                 maxvec,it,prnt)
      implicit integer (a-z)
      real*8 psi, vec, hvec, trmat, eig, etmp, resid, t1, t2
      real*8 scale, cnverg, sdot, maxerr, err, temp
      character*16 status
      character*80 title
      character*4 itoc
      logical prnt
      dimension psi(n,*), vec(n,*), hvec(n,*), trmat(maxvec,*)
