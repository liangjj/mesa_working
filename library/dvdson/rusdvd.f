...
c
c***routines called    
c***end prologue       rusdvd
      subroutine rusdvd(hbuf,ibuf,diag,trials,eig01,eig02,eig03,
     1                  u01,u02,u03,pvec,hpvec,vec,b,btmp,etmp,
     2                  svec,resid,eig,reig,imeig,t1,t2,scale,cnverg,
     3                  thresh,n1,n2,n3,dim,n,nroots,ntrials,
     4                  maxit,maxvec,lenbuf,drctv,incore,ntot,
     5                  prnt,mattyp)
      implicit integer (a-z)
      real*8 hbuf, diag, trials, pvec, hpvec, vec, svec
      real*8 b, btmp, etmp, eig, reig, imeig, eig01, eig02, eig03
      real*8 u01, u02, u03
      ...
      dimension eig(ntrials), reig(ntrials), imeig(ntrials) 
...
c
     ...
     1                      //'of dimension N = '//itoc(nend)
         write(iout,7) title
c        
         call rdiag(btmp,btmp,eig,eig,eig,eig,svec,svec,svec,svec,svec,
