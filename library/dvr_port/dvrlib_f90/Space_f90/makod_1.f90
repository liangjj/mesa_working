...
!***references
!***routines called
!***end prologue       makod_1
!
  SUBROUTINE makod_1(hmat,kemat,norm,nr,nfun,prn)
  USE inout
  IMPLICIT NONE
  INTEGER                                :: nr, nfun
  INTEGER                                :: i
  REAL*8, DIMENSION(*)                   :: hmat
  REAL*8, DIMENSION(nr,*)                :: kemat
...
!
   ...
   IF(prn) THEN
      ...
      CALL prntrm(title,hmat,nfun,1,nfun,1,output)
   END IF
END SUBROUTINE makod_1
