...
c
c***routines called    
c***end prologue       v22dvr
      subroutine v22dvr(vecin,vecout,tmp,u1,u2,n1,n2,nc,nvc)
      ...
      common/io/inp, iout
      call ebc(tmp,u2,vecin,n2,n2,n1*nc*nvc)
      do 10 ic=1,nc
         do 20 i=1,nvc
            call ebct(vecout(1,1,ic,i),tmp(1,1,ic,i),u1,n2,n1,n1)  
 20      continue
 10   continue    
      return
      end       
