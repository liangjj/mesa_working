...
c
c***routines called    
c***end prologue       v2t2dvr
      subroutine v2t2dvr(vecin,vecout,tmp,u1,u2,n1,n2,nt,nc,nvc)
      ...
      common/io/inp, iout
      call ebc(tmp,u2,vecin,n2,n2,n1*nt*nc*2*nvc)
      do 10 i=1,nt
         do 20 ic=1,nc 
            do 30 j=1,nvc
               call ebct(vecout(1,1,i,ic,1,j),
     1                   tmp(1,1,i,ic,1,j),u1,n2,n1,n1) 
               call ebct(vecout(1,1,i,ic,2,j),
