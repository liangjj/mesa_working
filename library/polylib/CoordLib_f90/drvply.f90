...
!     recursion relationship.
  ...
  SUBROUTINE drvply(q,wt,p,dp,ddp,edge,typwt,parity,angmom,nord,nq,prn)
...
!     go directly to getting the coordinate functions.
     ...
     END IF
     CALL cpoly(p,dp,ddp,q,a,n,nord,parity,prn(5))
  ELSE
!  
...
!  
    CALL cpoly(p,dp,ddp,q,scrat,nord-1,nord,parity,prn(5))
!  
