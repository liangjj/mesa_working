*deck @(#)cider.f	5.1  11/6/94
      subroutine cider(num,nder,nat,lag,u,intd1e,d1e,ops)
c
...
c                      storing gradients as cartesian first derivatives
c
...
c
      common /io/ inp,iout
c..bhl
c      call iosys('read integer "last of shell" from rwf',nshell,
c     #            maxshl,0,' ')
c..bhl
