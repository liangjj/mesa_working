...
c     --- input variables -----
      ...
      integer nbasis,ncharge,maxrts
      integer wpadti, need, ngot
      character*(*) ops
      logical dolp
...
c     --- local variables ---
      integer inp,iout
      integer mxpts
      integer i,iatom,jatom,itype,jtype,jtypmx,imax,jmax,nprimi,nprimj
...
c
c      data h   /0.0d+00
c     2,         -.707106781186548d+00,  0.707106781186548d+00
c     3,         -1.22474487139159d+00,0.0d+00,1.22474487139159d+00
c     4,         -1.65068012388578d+00, -0.524647623275290d+00
c     4,          0.524647623275290d+00, 1.65068012388578d+00
c     5,   -2.02018287045609d+00,-0.958572464613819d+00,0.0d+00
c     5,          0.958572464613819d+00, 2.02018287045609d+00
c     6,         -2.350604973674d+00  , -1.335849074014d+00
c     6,         -0.436077411928d+00  ,  0.436077411928d+00
c     6,          1.335849074014d+00  ,  2.350604973674d+00/
c      data wt  /1.77245385090552d+00
c     2,         0.8862269254528d+00  ,  0.8862269254528d+00
c     3,         0.2954089751509d+00  ,  1.181635900604d+00
c     3,         0.2954089751509d+00
c     4,         8.131283544725d-02   ,  8.049140900055d-01
c     4,         8.049140900055d-01   ,  8.131283544725d-02
c     5,         1.995324205905d-02   ,  3.936193231522d-01
c     5,         9.453087204829d-01   ,  3.936193231522d-01
c     5,         1.995324205905d-02
c     6,         4.530009905509d-03   ,  1.570673203229d-01
c     6,         7.246295952244d-01   ,  7.246295952244d-01
c     6,         1.570673203229d-01   ,  4.530009905509d-03/
c      data mxpts /21/
c      save h,wt,mxpts
c
      common/io/inp,iout
...
c
c     calculate the gauss-hermite points and weights
c
      mxpts=0
      do 1 i=1,maxrts
         mxpts=mxpts+i
 1    continue
      ...
      wt=h+mxpts
      bscr=wt+mxpts
      need=wpadti(bscr+maxrts)
      call getmem(need,phwt,ngot,'roots',0)
      call ghermi(hwt(h),hwt(wt),hwt(bscr),maxrts,mxpts,.false.)
c
...
c                 --- form the two-dimensional integrals ---
     ...
     $                       nbtype,hwt(h),hwt(wt),mxpts,z(a),z(b))
c
...
c                 --- form the primitive integrals ---
     ...
     $                       z(expon),z(xyz),npint,nprim,nat,
     $                       nbtype,hwt(h),hwt(wt),mxpts,z(a),z(b),
     $                       z(aiaj),z(xyz0),z(rysrt),z(ryswt),nroots,
