...
c
      if (n.ne.nv) then
         write (iout,99) n,nv
   99    format (//,' ##### m303: tints, error, n and nv:',2i8,//)
         call lnkerr('m303: tints error in vector lengths')
      end if
c
...
c
      do 9 j=0,jmax
         do 8 i=0,imax
            call vmul(xyz(1,i,j,3,0,1),xyz(1,i,j,3,0,1),expon,n)
            call vmul(xyz(1,i,j,3,0,2),xyz(1,i,j,3,0,2),expon,n)
            call vmul(xyz(1,i,j,3,1,1),xyz(1,i,j,3,1,1),expon,n)
            call vmul(xyz(1,i,j,3,1,2),xyz(1,i,j,3,1,2),expon,n)
    8    continue
    9 continue
c
c
