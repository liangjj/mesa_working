...
c***begin prologue     tints.f
c***date written       840724
c***revision date      11/6/94      
c
c***keywords           
c***author             saxe, paul(lanl)
c***source             @(#)tints.f	5.1   11/6/94
c***purpose            
c***description
...
c     --- local variables ---
      ...
      integer coord,ni,nj,minpts,maxpts,npts,point,i,j
      ...
      do 7 ni=0,imax
         do 6 nj=0,jmax
            ...
            if(maxpts.gt.mxpts) then
               call lnkerr('tints:not enough rys points')
            endif
            do 5 coord=1,3
