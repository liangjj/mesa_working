...
c                      rdbas(m401), rdmo(m401), schmdt(math),
...
c***end prologue       prjges.f
      ...
      real*8 z,c(nbasi,nbasi),eigval(nbasi),smhalf(nnp)
      real*8 maxerr
...
c
     ...
     $        -1,z(atomz),0,' ')
         call sizmb(natj,nprimj,ncontj,nbasj,a(atomno),z(atomz))
      endif
c
...
c
      ...
      t3=t2+nbsq
      t4=t3+nbsq
      top=wpadti(t4+nbsq+30000)
      call getmem(top,p,ngot,'prjges',0)
c
c     read in current basis set information.
      call rdbas('rwf',z(exi),z(conti),z(ci),a(ptprmi),a(noprmi),
...
c     generate guess vectors.
      if(gestyp.eq.'rdchk') then
         call rdbas('chk',z(exj),z(contj),z(cj),a(ptprmj),a(noprmj),
...
c
         call ovrlap(z(cj),z(cj),z(exj),z(exj),z(top),z(contj),z(contj),
     $            z(s),a(ptprmj),a(ptprmj),a(noprmj),a(noprmj),
     $            a(nocntj),a(nocntj),a(ptcntj),a(ptcntj),natj,natj,
     $            nprimj,nprimj,nleft,ntypes,nbtype,ncontj,ncontj,
     $            a(strtj),a(strtj),nbasj,nbasj,a(nocart),a(nobf),
...
c
         call ovrlap(z(ci),z(ci),z(exj),z(exj),z(top),z(contj),z(contj),
     $            z(s),a(ptprmj),a(ptprmj),a(noprmj),a(noprmj),
     $            a(nocntj),a(nocntj),a(ptcntj),a(ptcntj),natj,natj,
     $            nprimj,nprimj,nleft,ntypes,nbtype,ncontj,ncontj,
     $            a(strtj),a(strtj),nbasj,nbasj,a(nocart),a(nobf),
...
c
     ...
     #          iveceq(a(ptprmi),a(ptprmj),ntypes*nati).and.
     #          iveceq(a(noprmi),a(noprmj),ntypes*nati).and.
     #          iveceq(a(nocnti),a(nocntj),ntypes*nati).and.
     #          iveceq(a(ptcnti),a(ptcntj),ntypes*nati)) then
c
...
c        and a flag for the core orbitals.
         call minbas(natj,z(exj),z(contj),a(ptprmj),a(noprmj),
     $            a(ptcntj),a(nocntj),a(strtj),a(pstart),a(nctype),
     $            a(atomno),z(atomz),a(nocart),a(nobf),
     $            a(maxmom),a(minmom),a(mintyp),a(nx),a(ny),a(nz),natj,
     $            nprimj,ncontj,nbasj,ntypes,nbtype,lenxyz,z(ediag),
     $            a(corflg))
c
...
c        get the huckel vectors.
         call hukmat(z(s),z(smbhlf),z(ediag),a(corflg),z(hmat),
...
c
      if(gestyp.ne.'rdinp') then
         call ovrlap(z(cj),z(cj),z(exi),z(exj),z(top),z(conti),z(contj),
     $               z(s),a(ptprmi),a(ptprmj),a(noprmi),a(noprmj),
     $               a(nocnti),a(nocntj),a(ptcnti),a(ptcntj),nati,natj,
     $               nprimi,nprimj,nleft,ntypes,nbtype,nconti,ncontj,
     $               a(strti),a(strtj),nbasi,nbasj,a(nocart),a(nobf),
     $               a(maxmom),a(minmom),a(mintyp),a(nx),a(ny),a(nz),
     $               lenxyz)
c
...
c
c
      call getmem(-ngot,p,idum,'prjges',idum)
      return
      end
