...
c
 1000 format(5x,a8,'projected vectors')
 1010 format(5x,a8,'overlap matrix')
 1015 format(5x,'symprj found symmetry contamination')
...
c           check to see that things look ok.
            if (nkept.ne.nsf) then
               write(iout,*) ' nkept,nsf',nkept,nsf
