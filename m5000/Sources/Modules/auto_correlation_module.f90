...
!***end prologue       auto_corr_d
  ...
  IMPLICIT NONE
  REAL(idp)                                 :: corr_fn
  REAL(idp), DIMENSION(n3d)                 :: vector_0, vector
!
  REWIND 99
  READ(99) vector_0
  IF(spdim == 1 ) THEN
...
!***end prologue       auto_corr_1d_d
  ...
  IMPLICIT NONE
  REAL(idp), DIMENSION(nphy(1))          :: vector_0, vector
  REAL(idp)                              :: corr_fn, val, x, xx
  REAL(idp)                              :: ddot
  INTEGER                                :: i
!
...
!***end prologue       auto_corr_2d_d
  ...
  IMPLICIT NONE
  INTEGER                                   :: i, j 
  REAL(idp), DIMENSION(nphy(2),nphy(1))     :: vector_0, vector
  REAL(idp)                                 :: corr_fn
  REAL(idp)                                 :: ddot, val, x, xx, y, yy
...
!***end prologue       auto_corr_3d_d
  ...
  IMPLICIT NONE
  INTEGER                                           :: i, j, k 
  REAL(idp), DIMENSION(nphy(3),nphy(2),nphy(1))     :: vector_0, vector
  REAL(idp)                                         :: corr_fn
  REAL(idp)                                         :: ddot, val, x, xx, y, yy, z, zz
