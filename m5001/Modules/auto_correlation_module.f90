!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                     MODULE auto_correlation_module
                     USE accuracy
...
!***end prologue       auto_corr_d
  ...
  IMPLICIT NONE
  REAL(idp)                                 :: corr_fn
  REAL(idp), DIMENSION(n3d)                 :: vector_0
  REAL(idp), DIMENSION(n3d)                 :: vector
!
!  REWIND 99
!  READ(99) vector_0
  Call Iosys('read real initial_state_vector from tdse',n3d,vector_0,0,0)
  IF(spdim == 1 ) THEN
...
!***end prologue       auto_corr_z
  ...
  IMPLICIT NONE
  COMPLEX(idp)                       :: corr_fn
  COMPLEX(idp), DIMENSION(n3d)       :: vector_0
  COMPLEX(idp), DIMENSION(n3d)       :: vector
!
!  REWIND 99
!  READ(99) vector_0
  Call Iosys('read real initial_state_vector from tdse',2*n3d,vector_0,0,0)
  IF(spdim == 1 ) THEN
...
!***end prologue       auto_corr_1d_d
  ...
  IMPLICIT NONE
  REAL(idp), DIMENSION(nphy(1))          :: vector_0
  REAL(idp), DIMENSION(nphy(1))          :: vector
  REAL(idp)                              :: corr_fn
  REAL(idp)                              :: val
  REAL(idp)                              :: x
  REAL(idp)                              :: xx
...
!***end prologue       auto_corr_1d_z
  ...
  IMPLICIT NONE
  COMPLEX(idp), DIMENSION(nphy(1))    :: vector_0
  COMPLEX(idp), DIMENSION(nphy(1))    :: vector
  REAL(idp)                           :: val
  REAL(idp)                           :: x
  REAL(idp)                           :: xx
  COMPLEX(idp)                        :: cdotc
...
!***end prologue       auto_corr_2d_d
  ...
  IMPLICIT NONE
  INTEGER                                   :: i, j 
  REAL(idp), DIMENSION(nphy(2),nphy(1))     :: vector_0
  REAL(idp), DIMENSION(nphy(2),nphy(1))     :: vector
  REAL(idp)                                 :: corr_fn
  REAL(idp)                                 :: ddot
  REAL(idp)                                 :: val
  REAL(idp)                                 :: x
...
!***end prologue       auto_corr_2d_z
  ...
  INTEGER                                  :: i
  INTEGER                                  :: j 
  COMPLEX(idp), DIMENSION(nphy(2),nphy(1)) :: vector_0
  COMPLEX(idp), DIMENSION(nphy(2),nphy(1)) :: vector
  REAL(idp)                                :: val
  REAL(idp)                                :: x
  REAL(idp)                                :: xx
  REAL(idp)                                :: y
...
!***end prologue       auto_corr_3d_d
  ...
  INTEGER                                           :: j 
  INTEGER                                           :: k 
  REAL(idp), DIMENSION(nphy(3),nphy(2),nphy(1))     :: vector_0
  REAL(idp), DIMENSION(nphy(3),nphy(2),nphy(1))     :: vector
  REAL(idp)                                         :: corr_fn
  REAL(idp)                                         :: ddot
  REAL(idp)                                         :: val
  REAL(idp)                                         :: x
...
!***end prologue       auto_corr_3d_z
  ...
  INTEGER                                           :: j 
  INTEGER                                           :: k 
  COMPLEX(idp), DIMENSION(nphy(3),nphy(2),nphy(1))  :: vector_0
  COMPLEX(idp), DIMENSION(nphy(3),nphy(2),nphy(1))  :: vector
  REAL(idp)                                         :: val
  REAL(idp)                                         :: x
  REAL(idp)                                         :: xx
  REAL(idp)                                         :: y
...
!***********************************************************************
!***********************************************************************
END MODULE auto_correlation_module
