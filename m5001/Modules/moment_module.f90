...
!
  ...
  IMPLICIT NONE                          
  COMPLEX(idp), DIMENSION(n3d)             :: vec_z
  REAL(idp)                                :: t_calc
  IF (spdim == 1 ) THEN
...
!
  ...
  IMPLICIT NONE                          
  REAL(idp), DIMENSION(nphy(1))             :: vec_1d
  REAL(idp)                                 :: t_calc
  REAL(idp)                                 :: av
  REAL(idp)                                 :: avv
  REAL(idp)                                 :: fac_1d
...
!
  ...
  IMPLICIT NONE                          
  REAL(idp), DIMENSION(nphy(2),nphy(1))        :: vec_2d
  REAL(idp), DIMENSION(2)                      :: av
  REAL(idp), DIMENSION(2)                      :: avv
  REAL(idp), DIMENSION(2)                      :: exav
  REAL(idp), DIMENSION(2)                      :: exavv
  REAL(idp)                                    :: fac_2d
  REAL(idp)                                    :: t_calc
  INTEGER                                      :: i
  INTEGER                                      :: j
...
!
  ...
  IMPLICIT NONE                          
  REAL(idp), DIMENSION(nphy(3),nphy(2),nphy(1))     :: vec_3d
  REAL(idp), DIMENSION(3)                           :: av
  REAL(idp), DIMENSION(3)                           :: avv
  REAL(idp), DIMENSION(3)                           :: exav
  REAL(idp), DIMENSION(3)                           :: exavv
  REAL(idp)                                         :: fac_3d
  REAL(idp)                                         :: t_calc
  INTEGER                                           :: i 
  INTEGER                                           :: j
...
!
  ...
  IMPLICIT NONE                          
  COMPLEX(idp), DIMENSION(nphy(1))          :: vec_1d
  REAL(idp)                                 :: t_calc
  REAL(idp)                                 :: av
  REAL(idp)                                 :: avv
  REAL(idp)                                 :: fac_1d
...
!
  ...
  IMPLICIT NONE                          
  COMPLEX(idp), DIMENSION(nphy(2),nphy(1))     :: vec_2d
  REAL(idp), DIMENSION(2)                      :: av
  REAL(idp), DIMENSION(2)                      :: avv
  REAL(idp), DIMENSION(2)                      :: exav
  REAL(idp), DIMENSION(2)                      :: exavv
...
!
  ...
  IMPLICIT NONE                          
  COMPLEX(idp), DIMENSION(nphy(3),nphy(2),nphy(1))  :: vec_3d
  REAL(idp), DIMENSION(3)                           :: av
  REAL(idp), DIMENSION(3)                           :: avv
  REAL(idp), DIMENSION(3)                           :: exav
  REAL(idp), DIMENSION(3)                           :: exavv
