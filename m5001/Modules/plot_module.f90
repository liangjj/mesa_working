...
4 FORMAT('        x      ',5x,'        y      ',5x,'        z     ',               &
         '                              Psi  ')
5 FORMAT(e15.8,5x,e15.8)
6 FORMAT(e15.8,5x,e15.8,5x,e15.8)
7 FORMAT(e15.8,5x,e15.8,5x,e15.8,5x,e15.8)
...
5 FORMAT(e15.8,5x,e15.8,5x,e15.8)
6 FORMAT(e15.8,5x,e15.8,5x,e15.8,5x,e15.8)
7 FORMAT(e15.8,5x,e15.8,5x,e15.8,5x,e15.8,5x,e15.8)
...
!
  ...
  INTEGER                                :: k
  INTEGER                                :: count
  REAL(idp), DIMENSION(n3d)              :: propagator
!
  write(iout,1) title
  IF(spdim == 1 ) then
     write(iout,2)
...
!
  ...
  INTEGER                                :: k
  INTEGER                                :: count
  COMPLEX(idp), DIMENSION(n3d)           :: propagator
!
  write(iout,1) title
  IF(spdim == 1 ) then
     write(iout,2)
...
1 FORMAT(a80)
2 FORMAT('     x      ',5x,' Propagator ')
3 FORMAT(e15.8,5x,e15.8,5x,e15.8)
4 FORMAT('     x      ',5x,'     y      ',5x,' Propagator ')
5 FORMAT(e15.8,5x,e15.8,5x,e15.8,5x,e15.8)
6 FORMAT('     x      ',5x,'     y      ',5x,'     z     ',5x,' Propagator ')
7 FORMAT(e15.8,5x,e15.8,5x,e15.8,5x,e15.8,5x,e15.8)
