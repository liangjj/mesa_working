*deck @(#)scf.f	5.1 11/6/94
     ...
     $               bflabl,usesym,symlabl,salc,numso,lambda,lirrep,
     $               nirrep,orbsym,occsym,temp,kept)
c
c   1 july    1993    rlm at lanl
...
c
c     ----- replace call to pseud with call to tomo
c           transform j and k to mo basis
c
      call tomo(nbf,nnp,nshell,ncoul,nexch,h,t1,jmat,kmat,
     $     c,t2,t3)
c
c     call pseud(nbf,nnp,nshell,ncoul,nexch,h,t1,jmat,kmat,
c    $     c,t2,t3,eigval,fcoef,alpha,beta,shlmin,shlmax,t4,t5,
c    $     ops)
c
c
...
c
      ...
      call putvec(c,eigval,nbf,noabort,usesym,orbsym,symlabl)
c
c
      return
      end
