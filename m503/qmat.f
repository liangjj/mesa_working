...
c
c***beginprologue     qmat
c***datewritten       850601   (yymmdd)
c***revisiondate      870513   (yymmdd)
c
...
c
c***keywordspseudocanonical scf, newton-raphson
c***authorsaxe, paul (lanl)
c***source@(#)qmat.f	1.2   7/30/91
c
c***purposeto form the 'q', eqs. 66, 84, or 111 and
...
c***description
c
c***referencesm. page and j. w. mciver, jr., jcp 79, 4985 (1983).
c
