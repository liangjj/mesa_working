*deck @(#)getpgrd.f	5.1  11/28/95
      subroutine getpgrd( )
c***begin prologue     getpgrd.f
c***date written       951121      (yymmdd)  
c***revision date      11/28/95
c
c***keywords           
c***author             russo, thomas(lanl)
c***source             @(#)getpgrd.f	5.1 11/28/95
...
c        form voronoi weights for catenated grid & save
         call voronoi(natoms,c,grid,twts,ngrid,ngrid,iatom,
     $        tvwts,rnuc,amu,pwtx,rr,adjust,radii)
