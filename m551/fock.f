*deck @(#)fock.f	1.2  7/30/91
      subroutine fock(values,d,f,nnp,itap44,num,fsq,isq,ntriang)
c
...
c***source             @(#)fock.f	1.2   7/30/91
c
c***purpose
c
c***description
c
c           to form the two-electron contribution to the fock matrix
