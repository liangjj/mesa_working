*deck @(#)mcrdk.f	1.1  11/30/90
      subroutine mcrdk(xjk,nblock,ndab,jkst,iocore)
c
c***begin prologue
...
c
      call iosys('read real mc_k from mcscr',nblock,xjk,jkst,' ')
      jkst=jkst+nblock
c
      return
      end
