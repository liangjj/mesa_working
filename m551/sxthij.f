*deck @(#)sxthij.f	1.1  11/30/90
      subroutine sxthij(mixinv,hess,cj,ci,nbfj,nbfi,lenj,leni,mixj,
     $     mixi,locj,loci,jpt,ipt,jsym,jorb,isym,iorb,tv,htran,
...
c***source             @(#)sxthij.f	1.1   11/30/90
c
c***purpose
c
c***description
