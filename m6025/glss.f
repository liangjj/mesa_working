*deck glss
      ...
      k=ik
      l=il
      if(m.le.0.or.n.le.0.or.k.le.0.or.l.le.0) then
         write(6,1515) m,n,k,l
         call exit
      endif
      if(m.gt.ia.or.m.gt.iy.or.l.gt.ib.or.l.gt.jx) then
         write(6,2525)
         call exit
      endif
  100 do1i=1,l
   ...
   25 x(i,j)=-x(i,j)
   27 return
 1515 format(/,5x,'glss called with arrays dimensioned wrong',/,5x,
     1            'm=',1x,i4,1x,'n=',1x,i4,1x,'k=',1x,i4,1x,'l=',1x,i4)
