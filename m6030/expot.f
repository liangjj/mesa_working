*deck expot 
c***begin prologue     expot 
c***date written       921701   (yymmdd)
c***revision date               (yymmdd)
c***keywords           m6005, link 6005, model potential
c***author             schneider, barry (nsf)
c***source             m6005
c***purpose            complex exponential model potential 
c***references         none
c
c***routines called    none
c***end prologue       expot 
      subroutine expot(v,vcple,grid,nchan,npnts,ntri)
