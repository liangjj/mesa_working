...
c***end prologue       lebdev
     ...
     1                  npts,str)
      ...
      dimension r(1), u(1), w(1), angle(npts,3)
      common /io/ inp, iout
...
c              the a2 nodes-these are independent of the quadrature
      if (nleb.eq.11.or.nleb.eq.13.or.nleb.eq.23) then
...
c              the a3 nodes-these are independent of the quadrature
   ...
   35     continue
          do 45 i=7,14    
             wt(i)=biga(3)
   45     continue               
          call getcnd(pt(1,ii+9),wt(ii+9),p,q,bigc)
          npts=38
   ...
   25     continue
          ...
          wt(26)=biga(3)
          call getbnd(pt(1,ii+9),wt(ii+9),l,m,bigb,nleb)
          call getcnd(pt(1,ii+33),wt(ii+33),p,q,bigc)
          npts=74
...
c      write(iout,*) 'lebedev points and weights'
c      do 55 i=1,npts
c         write(iout,56) pt(1,i), pt(2,i), pt(3,i), wt(i)
c   55 continue
   56 format(4e15.8)
