...
!
  ...
  IF(print_mat(7)) then
     DO i = 1, n_reg
        write(iout,2) type
         call Print_Matrix(type_real_vector,shl(i)%pot,title='potential-'//itoc(i))
     END DO
  END IF
!
!
