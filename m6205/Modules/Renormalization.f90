...
!
!
                            INTERFACE Normalized_Matrix_Elements                       
                       MODULE PROCEDURE Normalized_Even_Matrix_Elements,   &
                                        Normalized_Odd_Matrix_Elements  
                            END INTERFACE Normalized_Matrix_Elements
!
!***********************************************************************
!***********************************************************************
                              CONTAINS
...
!***end prologue       Normalization
  ...
  SUBROUTINE Normalization(reg,nreg)
  IMPLICIT NONE
...
!***routines called    iosys, util and mdutil
!***end prologue
  SUBROUTINE Normalized_Functions(reg,nreg)
  IMPLICIT NONE
  TYPE(regional), DIMENSION(:)   :: reg
  INTEGER                        :: nreg
  INTEGER                        :: i
...
!***********************************************************************
!***********************************************************************
!deck Normalized_Even_Matrix_Elements
!***begin prologue     Normalized_Even_Matrix_Elements
!***date written       960718   (yymmdd)
!***revision date               (yymmdd)
!***keywords           lobatto functions
!***author             schneider, b. i.(nsf)
...
!***routines called    iosys, util and mdutil
!***end prologue       Normalized_Even_Matrix_Elements
  SUBROUTINE Normalized_Even_Matrix_Elements(even,reg,nreg)
  IMPLICIT NONE
  TYPE(regional), DIMENSION(:)         :: reg
...
!
!
       Call Normalize_Kinetic_Energy (reg(i)%even%ham,               &
                   reg(i)%even%tr,                                   &
                   reg(i)%normalization,                             &
                   reg(i)%n_pts)
  ELSE
...
!
  IF (prnt(4) == .true. ) THEN
      ...
      END DO
  END IF
END SUBROUTINE Normalized_Even_Matrix_Elements
!***********************************************************************
!***********************************************************************
!deck Normalized_Odd_Matrix_Elements
!***begin prologue     Normalized_Odd_Matrix_Elements
!***date written       960718   (yymmdd)
!***revision date               (yymmdd)
!***keywords           lobatto functions
!***author             schneider, b. i.(nsf)
...
!***end prologue       Odd_Renormalization
  ...
  SUBROUTINE Normalized_Odd_Matrix_Elements(odd,reg,nreg)
  IMPLICIT NONE
...
!
       i = 1
!
       Call Normalize_Kinetic_Energy (reg(i)%odd%ham,               &
                   reg(i)%odd%tr,                                   &
                   reg(i)%normalization,                            &
                   reg(i)%n_pts)
  ELSE
...
!
  ...
  END DO
END SUBROUTINE Normalized_Odd_Matrix_Elements
!***********************************************************************
!***********************************************************************
!deck Normalize_Kinetic_Energy.f
!***begin prologue     Normalize_Kinetic_Energy
!***date written       960718   (yymmdd)
!***revision date               (yymmdd)
!***keywords           lobatto functions
!***author             schneider, b. i.(nsf)
...
!***routines called    iosys, util and mdutil
!***end prologue       Normalize_Kinetic_Energy

  SUBROUTINE Normalize_Kinetic_Energy( ham, tr, norm, n , left_end_mat_el, right_end_mat_el )
  IMPLICIT NONE
...
!       
       ...
       ham(n,n) = norm(n) * ( tr(n,n) + right_end_mat_el ) * norm(n)
  END IF
END SUBROUTINE Normalize_Kinetic_Energy
!***********************************************************************
!***********************************************************************
