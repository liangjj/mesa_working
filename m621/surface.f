...
c   26 september,1994  rlm at lanl
c      fixing bug in the way icomp is computed in the do 55 loop
c      according to bug found by gjt during the 3M port.
c
c***keywords
...
c        number of focus points added so far
  ...
  54     continue
         do 55 icnt = 1,ncnt
            icomp = nark(icnt+1)-nark(icnt)-ifocus(icnt)
