*deck @(#)prims.f	5.1  11/28/95
     ...
     $                 index,len)
c***begin prologue     prims.f
c***date written       851017  
c***revision date      11/6/94      
c   november 17,1985   pws at lanl
c      extensively modified version from m312 practically
c      rewritten for m712
c
c***keywords           
c***author             saxe, paul 
c***source             @(#)prims.f	5.1   11/28/95
c***purpose            
c***description
c     
c    
...
c***routines called
c
c***end prologue       prims.f
      implicit none
c     --- input variables -----
      integer nij,nkl,nv,lenv
      integer nmax,mmax,nroots,len
