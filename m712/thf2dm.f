*deck @(#)thf2dm.f	5.1  11/6/94
      subroutine thf2dm(d2cc,d2ac,d2aa,
     #                  dij,dkl,dik,djl,dil,djk,nprimi,nprimj,
     #                  nprimk,npriml,nfi,nfj,nfk,nfl,imgrp,jmgrp,
     #                  kmgrp,lmgrp,lend2,index,nv,len,
     #                  alpha,beta,nshell,ndmat)
c
c***begin prologue     thf2dm
...
c
      ...
      real*8 djk(nprimj,nprimk,nfj,nfk,ndmat),alpaa,betaa
      real*8 d2cc(lend2),d2ac(lend2),d2aa(lend2),alpac,betac
