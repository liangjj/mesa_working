...
c***source             @(#)fd2bnt.f	5.1   11/28/95
c***purpose
c***description
c***references         (none)
c
...
c
                  ...
                  call plnkerr('bad number of rys roots',401)
c
    5             continue
                     do 500 m=1,nv
...
c
   10             continue
                  call plnkerr('  fd2bnt: go to error ',402)
                     go to 15
   11             continue
                  call plnkerr('  fd2bnt: go to error ',403)
                     go to 15
   12             continue
                  call plnkerr('  fd2bnt: go to error ',404)
                     go to 15
   13             continue
                  call plnkerr('  fd2bnt: go to error ',405)
                     go to 15
c
c
   15             continue
