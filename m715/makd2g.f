...
c***source             @(#)makd2g.f	5.1   11/28/95
...
c***end prologue       makd2g.f
      implicit none
c     --- input variables -----
      integer nmax,mmax,nv,lenv,ncentr,nd2
