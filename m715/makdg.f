...
c***end prologue       makdg.f
      implicit none
c     --- input variables -----
      integer nmax,mmax,nv,lenv,ncentr
...
c     --- scratch arrays ---
c     --- local variables ---
      integer centr,i,coord,n,m
      real*8 scalr1,scalr2
c
c     --- g(0,0) ---
