*deck @(#)memory.f          
      subroutine memory(need,p,ngot,name,fail)
...
c***description
c                      call memory(need,p,ngot,name,fail)
c
...
c                         p      ... pointer to first word of variable.
...
c     the mesa suite.
c
c     the parameter below is set for a machine with 1GB of core
c
      parameter (maxcor=200000000)
c
      character*(*) name
      common/io/inp,iout
c
