...
c
 ...
 101   format(/,' kohn run: iout ')
 102   format(/,' kohn run: orbsym ')
 103   format(/,' kohn run: orbtbf ')
 201   format(10(1x,i4))
      end if
