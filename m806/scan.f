*deck @(#)scan.f	5.1  11/6/94
     ...
     #                ntype,bfnum,numsym,bfsym,bfkey,bfcode)
c
...
c
         if (code.le.10) then
            write (out,3) bf+1,bf+repcnt,repcnt,clef,words(code),sym
         else
            write (out,33) bf+1,bf+repcnt,repcnt,clef,code-10,sym
         end if
    3    format (t22,i3,'-',i3,i4,2x,a1,t43,a18,t61,i1)
   33    format (t22,i3,'-',i3,i4,2x,a1,t43,'orbital type',i3,t61,i1)
c
