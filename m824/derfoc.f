*deck @(#)derfoc.f	5.1  11/6/94
      subroutine derfoc(values,d,f,nnp,num,jmat,kmat,ncoul,
...
c
      call=call+1
      call iosys('rewind "sorted ao derivative integrals" on scr',
     $     0,0,0,' ')
c
