...
c
         call sorter('start',asort,asort,wpadti(lnsort),nnp*nnpact,5120,
     #               0,0,0,'half','scratch',prnt)
c
...
c
         ...
         call iosys('write real der_i(xbcd) to dints',
     #               nt,third,(nder-1)*nt,' ')
c
...
c..bhl
  500    continue
c
         call iosys('write real der_g to dints without rewinding',
     #               nnpact**2,mo,0,' ')
c
