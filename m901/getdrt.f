...
c
      ...
      call iosys('read integer inint from '//dsk,-1,inint,0,' ')
      call iosys('read integer inext from '//dsk,-1,inext,0,' ')
      call iosys('read integer jmnnxt from '//dsk,-1,jmnnxt,0,' ')
      call iosys('read integer jmxnxt from '//dsk,-1,jmxnxt,0,' ')
      call iosys('read integer ningrp from '//dsk,-1,ningrp,0,' ')
      call iosys('read integer orbsym from '//dsk,-1,orbsym,0,' ')
      call iosys('read integer levpt from '//dsk,-1,levpt,0,' ')
      call iosys('read integer a from '//dsk,-1,aval,0,' ')
      call iosys('read integer b from '//dsk,-1,bval,0,' ')
      call iosys('read integer s from '//dsk,-1,rowsym,0,' ')
      call iosys('read integer arc from '//dsk,-1,arc,0,' ')
      call iosys('read integer nlwks from '//dsk,-1,nlwks,0,' ')
      call iosys('read integer weight from '//dsk,-1,weight,0,' ')
      call iosys('read integer wtab from '//dsk,-1,wab,0,' ')
      call iosys('read integer wtw from '//dsk,-1,wtw,0,' ')
      call iosys('read integer wtx from '//dsk,-1,wtx,0,' ')
      call iosys('read integer wty from '//dsk,-1,wty,0,' ')
      call iosys('read integer ijxx from '//dsk,-1,ijxx,0,' ')
      call iosys('read integer klxx from '//dsk,-1,klxx,0,' ')
      call iosys('read integer nklxx from '//dsk,-1,nklxx,0,' ')
      call iosys('read integer ijww from '//dsk,-1,ijww,0,' ')
      call iosys('read integer klww from '//dsk,-1,klww,0,' ')
      call iosys('read integer nklww from '//dsk,-1,nklww,0,' ')
c
    9 continue
