*deck @(#)loopyd.f	5.1  11/6/94
     ...
     *,                 aint,file,unit,vector,sigma,wtw,wtx,wty,wab,ss
...
cpws         call allext
         call allext(aint,vector,sigma,ijadd,kadd,ladd,wtw,wtx,wty,
     #  wab,ss
     #,                 ci,si,cj,sj,h1,h2,ijxx,nklxx,ijww,nklww
     #,                 klxx,klww)
         go to 1010
...
320      kseg=kseg+1
         ...
         acf = acoef(levl)
         ladt=lad
         call loopin(aint,vector,sigma,ijadd,kadd,ladd,wtw,wtx,wty,
     #  wab,ss
     #,                 ci,si,cj,sj,h1,h2,ijxx,nklxx,ijww,nklww
     #,                 klxx,klww)
         go to 320
...
c
 ...
 470     continue
         ladt=kad
         jsmt=lsm
cpws 475     call loopex
  475 continue
         call loopex(aint,vector,sigma,ijadd,kadd,ladd,wtw,wtx,wty,
     #  wab,ss
     #,                 ci,si,cj,sj,h1,h2,ijxx,nklxx,ijww,nklww
     #,                 klxx,klww)
         goto 200
