*deck @(#)david.f	5.1  11/6/94

      subroutine david(c,s,nwks,mxvc,root,nroots,dvdvec,dvdmat,mxiter,
     $     nnpit,rep,fzcore,ops,ibuf,rbuf,lnbuf,prtflg,calc)
c
...
c
     ...
     $     1,ntotal,0,' ')
      call iosys('read real diagonals from hamiltonian',nwks,c,0,' ')
c
...
c
         call hmult(ibuf,rbuf,lnbuf,ntotal,c,s,nwks,1)
c
...
c
            call hmult(ibuf,rbuf,lnbuf,ntotal,c,s,nwks,nvc)
c
            do 80 ivc=1,nvc
