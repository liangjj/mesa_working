*deck @(#)hc02.f	5.1  11/6/94
      subroutine hc02(arc,wt,nlwks,ijadd,kadd,ladd,
     ...
     $     sirow,sjrow,ops,unit)
c
c***begin prologue     hc02
...
c
c
      call hclps(arc,wt,nlwks,ijadd,kadd,ladd,orbsym,b,ints,sirow,
