...
c
                  if (iwt.eq.jwt) then
                     do 432 walk=1,nlwks(inxt)
                        s(iwt+walk)=s(iwt+walk)+loop*c(iwt+walk)
 432                 continue
                  else
                     do 435 walk=1,nlwks(inxt)
                        s(jwt+walk)=s(jwt+walk)+loop*c(iwt+walk)
                        s(iwt+walk)=s(iwt+walk)+loop*c(jwt+walk)
 435                 continue
                  end if
                  go to 400
c
