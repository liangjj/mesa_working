*deck  @(#)loops.f	5.1 11/6/94
     ...
     $     imngrp,imxgrp,jmngrp,jmxgrp,ngroup,unit,ioff,joff,ops)
c
...
c
     ...
     v,           4,  1,  2,  2,  2,  3,  4,  4/
      save segmax,trak,kcond,jcond,nxtpag,jarc,iarc
c
      data pass/0/
      save pass
...
c
 ...
 9001       format (5x,'m902: guga integrals',/,
     $           (5x,5f12.6))
         end if
c
         imin=imngrp(group)
