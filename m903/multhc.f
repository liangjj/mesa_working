*deck @(#)multhc.f	5.1  11/6/94
      subroutine multhc(uparc,dnarc,upwt,dnwt,upnwks,dnnwks,a,b,sval,
     #                  levpt,levnr,rowoff,
...
c***description
c
c          multhc forms the product vector s of tha hamiltonian matrix
...
c
      common /io/ inp,iout
c
c     ----- zero the product vector for accumulation -----
c
      call rzero(s,nwks)
c
...
c
      ...
      left=maxcor-top+1
c
      call oneel(uparc,dnarc,upwt,dnwt,upnwks,dnnwks,a,b,
     #           levpt,levnr,rowoff,
     #           nrows,nlevs,norbs,
     #           acoef,irowsv,jrowsv,iwtsv,jwtsv,pagesv,segsv,
...
c
         ...
         ptsym=offsym(sym)+1
c
         call twoel(uparc,dnarc,upwt,dnwt,upnwks,dnnwks,a,b,
     #              levpt,levnr,rowoff,
