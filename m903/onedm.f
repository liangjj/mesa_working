*deck @(#)onedm.f	5.1  11/6/94
      subroutine onedm(uparc,dnarc,upwt,dnwt,upnwks,dnnwks,a,b,
     #                  levpt,levnr,rowoff,
     #                  nrows,nlevs,norbs,
...
ci     #                h,z(ec),1,nnp0,nkwks)
            call apbc(h,z(ec),c(rowoff(irow)+1+(mink-1)*kdnnwk),
     $           nnp0,nkwks,1)
c
c
