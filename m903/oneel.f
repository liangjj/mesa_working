*deck @(#)oneel.f	5.1  11/6/94
      subroutine oneel(uparc,dnarc,upwt,dnwt,upnwks,dnnwks,a,b,
     #                  levpt,levnr,rowoff,
     #                  nrows,nlevs,norbs,
...
c
     ...
     #                c,nwks,z(pt1),mink,maxk)
c
            call apbc(s(rowoff(irow)+1+(mink-1)*kdnnwk),
     #                h,z(ec),1,nnp0,nkwks)
c
c
