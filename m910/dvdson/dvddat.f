...
c
      ...
      mxvec=intkey(ops,'ci=maximum-number-of-vectors',15,' ')
 ...
 50      continue
      ...
      write(iout,1) nroots, nattim, nwks, nwksg, mxiter, mxvec, 
     1              thresh, cnverg
 1    format(/,15x,'iterative diagonalization information',/,/,5x,
     ...
     6             'max. number of vectors    = ',i6,/,5x, 
     7             'overlap tolerance         = ',e15.8,/,5x,
