...
c
      ...
      real*8 vector(nwksmx),sigma(nwksmx)
...
c
  ...
  200 if(nlwki.gt.nwksmx) return
      ...
      ieqj=.true.
      pagein=.true.
      nlwki2=intowp(nlwki+nlwki)
      nlwkj2=nlwki2
      noffi=puwkt+iuwk-1
      noffj=noffi
      iwalk=intowp(noffi+noffi)
      ii=1
      jj=1
      fword=iwalk+iword6
       call lnkerr(' paging not supported in dm')
c      call wreadw(itap06,sigma,nlwki2,fword,junk)
      ir6(ilev)=ir6(ilev)+1
...
c      call wreadw(itap06,sigma,nlwki2,fword,junk)
      ...
      fword=jwalk+iword6
      jj=nlwki+1
c      call wreadw(itap06,sigma(jj),nlwkj2,fword,junk)
      ir6(ilev)=ir6(ilev)+1
...
c
      call lnkerr(' nopaging supported in dm ')
c
      pagein=.false.
      fword=iwalk+iword6
c      call wwritw(itap06,sigma(ii),nlwki2,fword,junk)
      iw6(ilev)=iw6(ilev)+1
      nw6(ilev)=nw6(ilev)+nlwki2
      fword=jwalk+iword6
c      call wwritw(itap06,sigma(jj),nlwkj2,fword,junk)
      iw6(ilev)=iw6(ilev)+1
...
c      call wwritw(itap06,sigma(ii),nlwki2,fword,junk)
  ...
  320 continue
      jj=nlwki+1
      juwksv=juwk
      nlwkj2=intowp(nlwkj+nlwkj)
      noffj=puwkt+juwk-1
      jwalk=intowp(noffj+noffj)
      noffj=noffj-nlwki
      fword=jwalk+iword6
c      call wreadw(itap06,sigma(jj),nlwkj2,fword,junk)
      ir6(ilev)=ir6(ilev)+1
...
c      call wwritw(itap06,sigma(jj),nlwkj2,fword,junk)
  ...
  350 iuwksv=iuwk
      ...
      fword=iwalk+iword6
      ii=1
c     call wreadw(itap06,sigma(ii),nlwki2,fword,junk)
      ir6(ilev)=ir6(ilev)+1
      nr6(ilev)=nr6(ilev)+nlwki2
      fword=iwalk+iword3
...
c
      entry pageout
c
      call lnkerr(' paging is not supported in dm ')
c
