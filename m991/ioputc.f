...
c      write(iout,*) fword, nwords, first, last 
c
...
c            write(iout,*) 'reading in first record'
 10         continue
c
 ...
 20         continue
c            write(iout,*) (data(i),i=1,count)
c            write(iout,*) (buffer(i), i=offset+1,count+offset)
         else if (record.eq.last) then
c            write(iout,*) 'reading in last record'
c
