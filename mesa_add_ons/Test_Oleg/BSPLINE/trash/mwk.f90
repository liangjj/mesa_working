...
!======================================================================
!
!     Sets up matrix of wk integrals 
!
...
!=====================================================================
    ...
    INTEGER :: jsp, jth
    REAL(KIND=8),DIMENSION(ns) :: yk,ipvtz,ipvty
...
!  ... solve the matrix equation ...
       ...
       CALL dgbsl(dzk,3*ks-2,ns,ks-1,ks-1,ipvtz,yk,0)

!      Call DGBTRS ('N',ns,ks-1,ks-1,1,dzk,3*kx-2,ipvtz,yk,ns,info)
!      if( info .ne. 0 ) Stop ' calling dgbtrs failed in routine bspvyk'
!----------------------------------------------------------------------
!                                                          yk-function:
       yns = yk(ns)
...
!  ... solve the matrix equation
       ...
       CALL dgbsl(dyk,3*ks-2,ns,ks-1,ks-1,ipvty,yk,0)

!      Call DGBTRS ('N',ns,ks-1,ks-1,1,dyk,3*kx-2,ipvty,yk,ns,info)
!      if( info .ne. 0 ) Stop ' calling dgbtrs failed in routine bspvyk'
