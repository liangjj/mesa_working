...
!***end prologue       dvr_basis
  Subroutine dvr_basis(pt_0,pt_n,pt,wt,f,df,ddf,ke,p_mom,eigv_0,eigvec_0, &
...
!
  ...
  ELSE
     CALL lobatto(pt_0,pt_n,pt,wt,f,df,ddf,ke,p_mom,eigv_0,eigvec_0, &
                     h,eigv,eigvec,v,srf_prm,srf_0,srf,              &
