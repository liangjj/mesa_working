!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                     MODULE spatial_wavefunction_module
...
!***end prologue       spatial_psi_d
  ...
  USE dvrprop_global
  IMPLICIT NONE
  REAL*8, DIMENSION(:)                 :: wave_function, scratch_vector
!
  IF(spdim == 1 ) THEN
...
!***end prologue       spatial_psi_z
  ...
  USE dvrprop_global
  IMPLICIT NONE
  COMPLEX*16, DIMENSION(:)       :: wave_function, scratch_vector
!
  IF(spdim == 1 ) THEN
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
END MODULE spatial_wavefunction_module
