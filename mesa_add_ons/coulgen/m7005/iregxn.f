*deck iregxn
      subroutine iregxn(gl,dgl,a0,b0,c0,prefac,r,rinv,l,npt,n,level)
...
c
      ...
      real*8 expfac, fac, ifac, lgfac, fac1, fac2, fac3
      real*8 csum, dcsum, asum, dasum, bsum, dbsum
...
c**********************************************************************c
         ...
         if (l.ne.0) then
             ifac=(half*rinv(pt))**l
             expfac=ifac*expfac
             dxpfac=ifac*dxpfac-l*expfac*rinv(pt)
         endif
c**********************************************************************c
...
c**********************************************************************c
         ...
         fac2 = asum*rinv(pt) + lgfac*dasum - dbsum
         fac3=csum-fac*fac1
         gl(pt)=expfac*fac3
         dgl(pt)=expfac*(dcsum-fac*fac2-twoel1*fac*fac1*rinv(pt)) +
     1           +dxpfac*fac3
         dgl(pt)=-dgl(pt)
         gl(pt)=-gl(pt)
   10 continue  
