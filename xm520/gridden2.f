*deck @(#)gridden2.f	5.1 6/20/95
      subroutine gridden(nbf,nmo,ng,mxgbsiz,c,phi,grad,
     $                   dengrid,dengrad,minesz,scr,scr2,
     $                   phibar,gradbar,dmcut,dograd)
c***begin prologue     gridden2.f
...
c***source             @(#)gridden2.f	5.1 6/20/95
...
c     --- local variables ---
      ...
      integer gb,i
      real*8 two,zero,sum,test,bfcut
...
c
c         dengrid(i)=sum over occupied mo: [c(mu,mo)*phi(i,mu)]**2
