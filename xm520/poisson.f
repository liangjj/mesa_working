...
c        --- pass the difference density to gofish.
     ...
     $               values(y2),zdiag,zoffdiag,rmdiag)
...
c               to the last one ---
            ...
            if(timeit) then
               write(iout,*) 'time for 3-site j-matrix',
     $                        dum4-dum1,dum5-dum2,dum6-dum3
            endif
c            write(iout,*)" 3-center jmat is:"
c            call print(jmat,nnp,nbf,iout)
c
c
            call timing(dum1,dum2,dum3)
...
c           --- pass the difference density to gofish.
     ...
     $        zdiag,zoffdiag,rmdiag)
c           add it to the 3-center piece.
            call vneg(t1,t1,nnp)
c            write(iout,*)" poisson bit of jmat is:"
c            call print(t1,nnp,nbf,iout)
