...
c
      subroutine fbnint(flm,psilm,j,y,wt,scr,lmax,m,n,nshell,nr,
     1                  nints,prnt)
      implicit integer (a-z)
      real*8 flm, psilm, wt, j, y, scr, int0f, int0b
      logical prnt
      dimension flm(n,m:lmax), wt(*), psilm(nints,m:lmax), j(n,0:lmax)
      dimension y(n,0:lmax), nr(nshell), scr(nints,2)
      common /io/ inp, iout
c----------------------------------------------------------------------c     
